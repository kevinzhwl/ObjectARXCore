...
public:
    ...
    virtual bool isBlockLayoutName        (const char * name) const = 0;
    virtual bool isBlockModelSpaceName    (const char * name) const = 0;
    virtual bool isBlockPaperSpaceName    (const char * name) const = 0;
    virtual bool isLayerDefpointsName     (const char * name) const = 0;
    virtual bool isLayerZeroName          (const char * name) const = 0;
    virtual bool isLinetypeByBlockName    (const char * name) const = 0;
    virtual bool isLinetypeByLayerName    (const char * name) const = 0;
    virtual bool isLinetypeContinuousName (const char * name) const = 0;
    virtual bool isRegAppAcadName         (const char * name) const = 0;
    virtual bool isTextStyleStandardName  (const char * name) const = 0;
    virtual bool isViewportActiveName     (const char * name) const = 0;
    ...
    virtual const char * blockModelSpaceName    () const = 0;
    virtual const char * blockPaperSpaceName    () const = 0;
    virtual const char * layerDefpointsName     () const = 0;
    virtual const char * layerZeroName          () const = 0;
    virtual const char * linetypeByBlockName    () const = 0;
    virtual const char * linetypeByLayerName    () const = 0;
    virtual const char * linetypeContinuousName () const = 0;
    virtual const char * regAppAcadName         () const = 0;
    virtual const char * textStyleStandardName  () const = 0;
    virtual const char * viewportActiveName     () const = 0;

    // --------- Symbol names ---------

    virtual int               compareSymbolName(
                                      const char * thisName,
                                      const char * otherName) const = 0;
    virtual bool              hasVerticalBar(
                                      const char * name) const = 0;
    virtual Acad::ErrorStatus makeDependentName(
                                      char *&      pNewName,
                                      const char * dwgName,
                                      const char * symbolName) const = 0;
    ...
    virtual Acad::ErrorStatus getBlockNameFromInsertPathName(
                                      char *&      pBlockName,
                                      const char * pathName) const = 0;
    virtual Acad::ErrorStatus getInsertPathNameFromBlockName(
                                      char *&      pPathName,
                                      const char * blockName) const = 0;

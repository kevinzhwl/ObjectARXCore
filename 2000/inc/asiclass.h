...
protected:
    ...
    virtual EAsiBoolean         setSQLSTATE (const char *);       // set SQLSTATE
...
public:
    ...
    virtual EAsiBoolean         GetStatus       (EAsiStatInfo, ulong *);     // Get check status
...
public:
	  ...
	  // 
	  EAsiBoolean				RegisterServices(void);	 // Register Services	
...
protected:
	...
	EAsiBoolean					InitAccessor		(ULONG, DBCOLUMNINFO *, const CAsiRow &,
													 ULONG *, DBBINDING	**,	HACCESSOR *,
													 EAsiBoolean);

	EAsiBoolean					DoChangeErrors		(HRESULT hr, ULONG, DBBINDING *);
    EAsiBoolean                 UpdateRow           (ULONG, DBCOLUMNINFO *, const CAsiRow &);
    EAsiBoolean                 InsertRow           (ULONG, DBCOLUMNINFO *, const CAsiRow &);

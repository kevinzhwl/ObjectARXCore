//////////////////////////////////////////////////////////////////////////////
//
//                     (C) Copyright 1994-1998 by Autodesk, Inc.
//
...
{
    acDocManager->pushResourceHandle(m_extensionModule.ModuleResourceInstance());
}

inline CAcModuleResourceOverride::CAcModuleResourceOverride (HINSTANCE hInst)
{
    acDocManager->pushResourceHandle(hInst ? hInst : 

...
Acad::ErrorStatus acutNewBuffer(char *&pOutput, size_t size);
Acad::ErrorStatus acutNewString(const char* pInput, char*& pOutput);
Acad::ErrorStatus acutUpdString(const char* pInput, char*& pOutput);
void              acutDelString(char*& pString);

inline void
acutDelBuffer(char*& pString)

...
typedef AcDb::FileVersion	FileVersion;
...
// enum AcDb::FileVersion

const AcDb::FileVersion kR12 = AcDb::kR12;
const AcDb::FileVersion kR13 = AcDb::kR13;
const AcDb::FileVersion kR13Custom = AcDb::kR13Custom;
const AcDb::FileVersion kMaxVersion = AcDb::kMaxVersion;

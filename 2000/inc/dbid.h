...
public:
    ...
    long           asOldId     () const;
    AcDbObjectId&  setFromOldId(long oldId);
...
inline
AcDbObjectId& AcDbObjectId::setFromOldId(long oldId)
{ mId = oldId; return *this; }
...
{ mId = (unsigned long)(pStub); return *this; }

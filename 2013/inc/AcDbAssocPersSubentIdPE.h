...
public:
    ...
    /// </para><para>
    /// When an AcDbAssocPersSubentId is created by AcDbAssocGeomDepoendency::setSubentity(),
    ...
    /// the parent object is erased but not its children. The childrent are not erased,

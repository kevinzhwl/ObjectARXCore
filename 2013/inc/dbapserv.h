...
public:    
    ...
    virtual ACHAR * getAlternateFontName() const { return (ACHAR*)ACRX_T(""); }

    virtual ACHAR * getFontMapFileName() const { return (ACHAR*)ACRX_T(""); }
    ...
    virtual bool notifyCorruptDrawingFoundOnOpen(AcDbObjectId id, Acad::ErrorStatus es) { return false; }

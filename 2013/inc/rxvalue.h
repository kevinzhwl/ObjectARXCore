...
#pragma pop_macro("new")
        ...
        {
            memcpy(this,&rhs,sizeof(AcRxValue));
            return *this;
        }
        /*
...
// On IOS, sizeof(AcRxValue) == 28
#ifndef _ADESK_IOS_
_STATIC_ASSERT(sizeof(AcRxValue)==32);
#endif
...
{
    memcpy(&m_value, &value,sizeof(const ACHAR*));
}
template<>
...
template<>
ACDB_PORT AcRxValue::AcRxValue(const AcGeMatrix3d& m) throw();

template<>
ACDB_PORT AcGeMatrix3d* rxvalue_cast<AcGeMatrix3d>(AcRxValue* value) throw();
#pragma endregion
...
template<>
ACDB_PORT AcRxValue::AcRxValue(const AcCmColor& clr) throw();
#pragma endregion
...
template<>
ACDB_PORT AcRxValue::AcRxValue(const AcDbDate& str) throw();
#pragma endregion
...
template<>
ACDB_PORT AcRxValue::AcRxValue(const AcUnderlayLayer& str) throw();
#pragma endregion
...
template<>
ACDB_PORT AcRxValue::AcRxValue(const AcGiMaterialColor& clr) throw();
#pragma endregion
...
template<>
ACDB_PORT AcRxValue::AcRxValue(const AcGiMaterialMap& clr) throw();
#pragma endregion
...
template<>
ACDB_PORT AcRxValue::AcRxValue(const AcGiShadowParameters& v) throw();
#pragma endregion

#pragma region AcGiShadowParameters2
class AcGiShadowParameters2;
template<> 
struct AcRxValueType::Desc<AcGiShadowParameters2> 
{
    ACDB_PORT static const AcRxValueType& value() throw();
    static void del();
};
...
template<>
ACDB_PORT AcRxValue::AcRxValue(const AcGiShadowParameters2& v) throw();
#pragma endregion
...
template<>
ACDB_PORT AcRxValue::AcRxValue(const AcGiSkyParameters& v) throw();
#pragma endregion
...
template<>
ACDB_PORT AcRxValue::AcRxValue(const AcGiToneOperatorParameters& v) throw();
#pragma endregion
...
template<>
ACDB_PORT AcRxValue::AcRxValue(const AcGiLightAttenuation& v) throw();
#pragma endregion
...
template<>
ACDB_PORT AcRxValue::AcRxValue(AcDbMText* const& pMText) throw();

template<>
ACDB_PORT AcDbMText* const* rxvalue_cast<AcDbMText*>(const AcRxValue * value) throw();
#pragma endregion
...
template<>
ACDB_PORT AcRxValue::AcRxValue(const AcDbTableCellBlockReference& tableCellBlkRef) throw();
#pragma endregion
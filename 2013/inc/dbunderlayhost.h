...
public:
    ...
    ACDB_PORT AcUnderlayLayer(AcUnderlayLayer const &);

    ACDB_PORT AcUnderlayLayer const & operator= (AcUnderlayLayer const &);

    friend ACDB_PORT bool operator == (AcUnderlayLayer const & l, AcUnderlayLayer const & r);
...
public:
    ...
    /// </summary>
    /// <returns>Returns Acad::eOk if successful</returns>
    virtual Acad::ErrorStatus getUnderlayLayer(int idx, AcUnderlayLayer& layer) const { return Acad::eNotImplemented; }
    /// <summary>

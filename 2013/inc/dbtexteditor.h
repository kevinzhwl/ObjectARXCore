...
public:
    ...
    /// </returns>
    ACDB_PORT Acad::ErrorStatus setLanguage(int charset);
    ///<summary> 
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus setFont(const AcString& fontname, bool bTrueType);
    ///<summary> 
    ...
    /// </returns>
    ACDB_PORT bool              isTrueType() const;
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus setHeight(double height);
    ///<summary> 
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus setColor(const AcCmColor& color);
    ///<summary> 
    ...
    /// </returns>
    ACDB_PORT AcCmColor         color() const;
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus toggleBold();
    ///<summary> 
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus toggleItalic();
    ///<summary> 
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus toggleUnderline();
    ///<summary> 
    ...
    /// </returns>
    ACDB_PORT bool              underline() const;
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus toggleOverline();
    ///<summary> 
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus toggleStrikethrough();
    ///<summary> 
    ...
    /// Returns true if overline is on, false otherwise.
    /// </returns>
    ACDB_PORT bool              strikethrough() const;
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus setObliqueAngle(double angle);
    ...
    /// </returns>
    ACDB_PORT double            obliqueAngle() const;
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus setTrackingFactor(double factor);
    ...
    /// </returns>
    ACDB_PORT double            trackingFactor() const;
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus setWidthScale(double scale);
    ///<summary> 
    /// Get width scale.
    ///</summary>
    /// <returns>
    /// Returns width scale.
    /// </returns>
    ACDB_PORT double            widthScale() const;
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus setFlowAlign(FlowAlign flowAlign);
    ///<summary> 
    /// Get flow align.
    ///</summary>
    /// <returns>
    /// Returns flow align.
    /// </returns>
    ACDB_PORT FlowAlign         flowAlign() const;
    ...
    /// </returns>
    ACDB_PORT static double     minObliqueAngle();
    ///<summary> 
    ...
    /// </returns>
    ACDB_PORT static double     maxObliqueAngle();
    ///<summary> 
    ...
    /// </returns>
    ACDB_PORT static double     minTrackingFactor();
    ///<summary> 
    ...
    /// </returns>
    ACDB_PORT static double     maxTrackingFactor();
    ///<summary> 
    ...
    /// </returns>
    ACDB_PORT static double     minWidthScale();
    ///<summary> 
    ...
    /// </returns>
    ACDB_PORT static double     maxWidthScale();
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus insertSymbol(ACHAR wch, int charset);
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus insertString(const AcString& str);
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus insertImportedText(InsertTextType insertType, LPVOID pData);
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus inputSpecialChar(Adesk::UInt32 c);
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus insertColumnBreak();
...
public:
    ...
    /// </returns>
    ACDB_PORT bool languageSupported(int charset) const;
    ///<summary> 
    ...
    /// </returns>
    ACDB_PORT bool fontSupported(const AcString& fontname, bool bTrueType) const;
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus stack();
    ...
    /// Returns true if selection is stackable.
    /// </returns>
    ACDB_PORT bool canUnStack() const;
    ///<summary> 
    /// UnStack the contents of the current selection. After unstacked the text 
    /// will contain the seperator chars which specify the stack type:
    /// For the horizontal stack, the seperator char is /.
    /// For the diagonal stack, the seperator char is #.
    /// For the tolerance stack, the seperator char is ^.
    /// For the decimal stack, the seperator char is ~.
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus    unStack();
    ...
    /// </returns>
    ACDB_PORT bool     singleStackSelected() const;
    ...
    /// </returns>
    ACDB_PORT Acad::ErrorStatus    getStack(AcDbTextEditorStack& stack) const;
    ///<summary> 
    ...
    /// single stack selected, it will return Acad::eNotApplicable.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus    setStack(const AcDbTextEditorStack& stack);
    ...
    /// </returns>
    ACDB_PORT void paragraph(AcArray<AcDbTextEditorParagraph*>& paragraphs);
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus combineParagraphs();
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus removeCharacterFormatting();
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus removeParagraphFormatting();
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus removeAllFormatting();
    ...
    /// </returns>
    ACDB_PORT bool canChangeCase() const;
    ///<summary> 
    ...
    /// </returns>
    ACDB_PORT bool changeToUppercase();
    ...
    /// returns false if no change was made.
    /// </returns>
    ACDB_PORT bool changeToLowercase();
    ...
    /// </returns>
    ACDB_PORT Acad::ErrorStatus getSelectionText(AcString& txt) const;
    ...
    /// </returns>
    ACDB_PORT bool     singleFieldSelected() const;
    ...
    /// </returns>
    ACDB_PORT AcDbField* field() const;
    ...
    /// </returns>
    ACDB_PORT Acad::ErrorStatus  updateField();
    ...
    /// single field selected, it will return Acad::eNotApplicable.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus  convertToPlainText();
protected:
    ACDB_PORT AcDbTextEditorSelection(const TextEditor* pImp);
    ACDB_PORT ~AcDbTextEditorSelection();
...
public:
    ...
    /// </returns>
    ACDB_PORT AcDbTextEditorParagraph* paragraph();
    ...
    /// </returns>
    ACDB_PORT AcDbTextEditorColumn*    column();
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus        setLocation(const AcDbTextEditorLocation& location);
    ///<summary> 
    ...
    /// </returns>
    ACDB_PORT AcDbTextEditorLocation* location() const;

protected:
    ACDB_PORT AcDbTextEditorCursor(const TextEditor* pImp);
    ACDB_PORT ~AcDbTextEditorCursor();
...
public:
    ...
    ///</summary>
    ACDB_PORT  AcDbTextEditorParagraphTab();
    ///<summary> 
    /// Destructor.
    ///</summary>
    ACDB_PORT ~AcDbTextEditorParagraphTab();
    ...
    /// Copy Constructor.
    ///</summary>
    ACDB_PORT AcDbTextEditorParagraphTab(const AcDbTextEditorParagraphTab&);
    ///<summary> 
    /// Operator =.
    ///</summary>
    ACDB_PORT AcDbTextEditorParagraphTab& operator=(const AcDbTextEditorParagraphTab&);
    ///<summary> 
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus setOffset(double offdist);
    ...
    /// </returns>
    ACDB_PORT ParagraphTabType  type() const;
    ///<summary> 
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus setType(ParagraphTabType type);
    ...
    /// </returns>
    ACDB_PORT WCHAR             decimalChar() const;
    ///<summary> 
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus setDecimalChar(WCHAR decchar);
...
public:
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus setAlignment(AlignmentType AlignmentType);
    ...
    /// </returns>
    ACDB_PORT AlignmentType alignment() const;
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus setFirstIndent(double firstIndent);
    ...
    /// </returns>
    ACDB_PORT double firstIndent() const;
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus setLeftIndent(double leftIndent);
    ...
    /// Returns first indent.
    /// </returns>
    ACDB_PORT double leftIndent() const;
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus setRightIndent(double rightIndent);
    ...
    /// </returns>
    ACDB_PORT double rightIndent() const;
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus setLineSpacingStyle(LineSpacingStyle lineSpacingStyle);
    ///<summary> 
    ...
    /// </returns>
    ACDB_PORT LineSpacingStyle  lineSpacingStyle() const;
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus setLineSpacingFactor(double lineSpacingFactor);
    ///<summary> 
    ...
    /// </returns>
    ACDB_PORT double            lineSpacingFactor() const;
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus setSpaceBefore(double spaceBefore);
    ///<summary> 
    ...
    /// </returns>
    ACDB_PORT double            spaceBefore() const;
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus setSpaceAfter(double spaceAfter);
    ///<summary> 
    ...
    /// </returns>
    ACDB_PORT double            spaceAfter() const;
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus setNumberingType(NumberingType type);
    ///<summary> 
    ...
    /// </returns>
    ACDB_PORT NumberingType     numberingType() const;
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus restartNumbering();
    ///<summary> 
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus continueNumbering();
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus addTab(const AcDbTextEditorParagraphTab& tab);
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus removeTab(const AcDbTextEditorParagraphTab& tab);
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus getTab(int i, AcDbTextEditorParagraphTab& tab);
    ...
    /// </returns>
    ACDB_PORT virtual AcDbTextEditorLocation* startOfText() ADESK_OVERRIDE;
    ///<summary> 
    ...
    /// </returns>
    ACDB_PORT virtual AcDbTextEditorLocation* endOfText() ADESK_OVERRIDE;
    ...
    /// </returns>
    ACDB_PORT double     minLineSpacingFactor() const;
    ///<summary> 
    ...
    /// </returns>
    ACDB_PORT double     maxLineSpacingFactor() const;
    ...
    /// </returns>
    ACDB_PORT double     minSpaceValue() const;
    ///<summary> 
    ...
    /// </returns>
    ACDB_PORT double     maxSpaceValue() const;
...
public:
    ...
    /// Constructor.
    ///</summary>
    ACDB_PORT AcDbTextEditorParagraphIterator(const AcDbTextEditor& textEditor);
    ///<summary> 
    /// Destructor.
    ///</summary>
    ACDB_PORT ~AcDbTextEditorParagraphIterator();
    ...
    /// </returns>
    ACDB_PORT AcDbTextEditorParagraph* current();
...
public:
    ...
    /// </returns>
    ACDB_PORT Acad::ErrorStatus setCount(int count);
    ...
    /// </returns>
    ACDB_PORT AcDbTextEditorColumn* getAt(int i);
    ...
    /// </returns>
    ACDB_PORT Acad::ErrorStatus setColumnType(AcDbMText::ColumnType type);
    ...
    /// Returns ColumnType.
    /// </returns>
    ACDB_PORT AcDbMText::ColumnType columnType() const;
    ...
    /// </returns>
    ACDB_PORT Acad::ErrorStatus setAutoHeight(bool bAutoHeight);
    ...
    /// </returns>
    ACDB_PORT bool autoHeight() const;
    ...
    /// Returns Acad::eNotApplicable if current column type is kNoColumns.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus setWidth(double value);
    ...
    /// Returns Acad::eNotApplicable if current column type is kNoColumns.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus setGutter(double value);
    ...
    ///Returns Acad::eNotApplicable if current column type is kNoColumns.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus setTotalWidth(double value);
    ...
    ///in the total.
    /// </returns>
    ACDB_PORT double totalWidth() const;
    ...
    /// </returns>
    ACDB_PORT bool   isFlowReversed() const;
    ...
    ///Returns Acad::eNotApplicable if current column type is kNoColumns.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus setIsFlowReversed(bool isFlowReversed);
...
public:
    ...
    ///</returns>
    ACDB_PORT static double     minBackgroundScaleFactor();
    ///<summary> 
    ...
    ///</returns>
    ACDB_PORT static double     maxBackgroundScaleFactor();
    ...
    ///</returns>
    ACDB_PORT bool              enableBackgroundFill() const;
    ///<summary> 
    ...
    ///Returns Acad::eInvalidInput if the operation fails.
    ///</returns>
    ACDB_PORT Acad::ErrorStatus setEnableBackgroundFill(bool bEnable);
    ...
    ///</returns>
    ACDB_PORT AcCmColor         getBackgroundFillColor() const;
    ///<summary> 
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    ///</returns>
    ACDB_PORT Acad::ErrorStatus setBackgroundFillColor(AcCmColor color);
    ...
    ///</returns>
    ACDB_PORT bool              useBackgroundColor() const;
    ///<summary> 
    /// Enable background fill (wipeout).
    ///</summary>
    ...
    ///Returns Acad::eInvalidInput if the operation fails.
    ///</returns>
    ACDB_PORT Acad::ErrorStatus setUseBackgroundColor(bool bUse);
    ...
    ///</returns>
    ACDB_PORT double            getBackgroundScaleFactor()const;
    ///<summary> 
    ...
    ///Returns Acad::eInvalidInput if the operation fails.
    ///</returns>
    ACDB_PORT Acad::ErrorStatus setBackgroundScaleFactor(double factor);
...
public:
    ...
    /// Copy constructor.
    ///</summary>
    ACDB_PORT AcDbTextEditorStack(const AcDbTextEditorStack&);
    ///<summary> 
    /// Operator =.
    ///</summary>
    ACDB_PORT AcDbTextEditorStack& operator=(const AcDbTextEditorStack&);
    ...
    /// Returns StackType.
    /// </returns>
    ACDB_PORT StackType        type() const;
    ///<summary> 
    /// Set StackType.
    ///</summary>
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus setType(StackType type);
    ...
    /// </returns>
    ACDB_PORT AcDbTextEditorSelectionBase::FlowAlign alignType() const;
    ///<summary> 
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus setAlignType(AcDbTextEditorSelectionBase::FlowAlign align);
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus setTop(const AcString& top);
    ...
    /// </returns>
    ACDB_PORT AcString           bottom() const;
    ///<summary> 
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus setBottom(const AcString& bottom);
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus setScale(double scale);
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus setDecimalChar(WCHAR decimalChar);
    ...
    /// </returns>
    ACDB_PORT static double       minStackScale();
    ///<summary> 
    ...
    /// Returns Minimum allowable stack scale.
    /// </returns>
    ACDB_PORT static double       maxStackScale();
...
public:
    ...
    /// to release it.
    /// </returns>
    ACDB_PORT static AcDbTextEditor* createDbTextEditor(AcDbMText* pMText);
    ...
    ACDB_PORT virtual void  close(ExitStatus stat);

    ///<summary> 
    /// Re-wrap, re-adjust and refresh all the text lines in editor.
    ///</summary>
    ACDB_PORT void   redraw();
    ...
    /// </returns>
    ACDB_PORT AcDbTextEditorColumns* columns();
    ...
    /// </returns>
    ACDB_PORT AcDbTextEditorWipeout* wipeout();
    ...
    /// paragraphs.
    /// </returns>
    ACDB_PORT AcDbTextEditorParagraphIterator* newParagraphsIterator();
    ...
    /// </returns>
    ACDB_PORT virtual AcDbTextEditorSelection* selection();
    ...
    /// </returns>
    ACDB_PORT virtual AcDbTextEditorCursor*    cursor();
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus clearSelection();
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus makeSelection(const AcDbTextEditorLocation* pStart,
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus findText(const ACHAR* text, int flags,
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus setAttachment(AcDbMText::AttachmentPoint attachment);
    ...
    /// </returns>
    ACDB_PORT AcDbMText::AttachmentPoint attachment() const;
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus setStyle(int index);
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus setStyle(AcDbObjectId styleId);
    ///<summary> 
    ...
    /// </returns>
    ACDB_PORT int               getIndexFromStyleName(const AcString& styleName);
    ...
    /// </returns>
    ACDB_PORT int               getStyleCount() const;
    ...
    /// </returns>
    ACDB_PORT AcString           getStyleName(int index) const;
    ...
    /// </returns>
    ACDB_PORT AcDbObjectId      style(int index) const;
    ...
    /// </returns>
    ACDB_PORT int               currentStyleIndex() const;
    ...
    /// </returns>
    ACDB_PORT bool              isAnnotativeStyle(int index) const;
    ...
    /// false.
    /// </returns>
    ACDB_PORT bool             isVerticalSHX() const;
    ...
    /// it returns false.
    /// </returns>
    ACDB_PORT bool             isVerticalTTF() const;
    ...
    /// </returns>
    ACDB_PORT Acad::ErrorStatus setDefinedWidth(double width);
    ...
    /// </returns>
    ACDB_PORT double            definedWidth() const;
    ...
    /// Returns Acad::ErrorStatus return code.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus setDefinedHeight(double height);
    ...
    /// </returns>
    ACDB_PORT double            definedHeight() const;
    ...
    /// </returns>
    ACDB_PORT double            textHeight() const;
    ///<summary> 
    ...
    /// Returns Acad::ErrorStatus return code.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus setTextHeight(double textHeight);
    ...
    /// </returns>
    ACDB_PORT double            actualWidth() const;
    ...
    /// </returns>
    ACDB_PORT double            actualHeight() const;
    ...
    /// Returns Acad::ErrorStatus return code.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus selectAll(); 
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus setAutoCAPS(bool autoCAPS);
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus setEnableNumbering(bool bEnable);
    ///<summary> 
    ...
    /// </returns>
    ACDB_PORT bool              numberingEnabled() const;
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus setAutolistEnabled(bool enabled);
    ///<summary> 
    ...
    /// </returns>
    ACDB_PORT bool              autolistEnabled() const;
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus setTabOnlyDelimiter(bool tabOnlyDelimiter);
    ///<summary> 
    ...
    /// </returns>
    ACDB_PORT bool              tabOnlyDelimiter() const;
    ...
    /// </returns>
    ACDB_PORT int               getFontCount() const;
    ///<summary> 
    ...
    /// </returns>
    ACDB_PORT AcString          getFontName(int index) const;
    ///<summary> 
    ...
    /// </returns>
    ACDB_PORT bool              isTrueTypeFont(int index) const;
    ...
    /// </returns>
    ACDB_PORT int               stackCount() const;
    ...
    /// </returns>
    ACDB_PORT double             defaultStackScale() const;
    ///<summary> 
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus    setDefaultStackScale(double scale);
    ...
    /// </returns>
    ACDB_PORT AcDbTextEditorSelectionBase::FlowAlign defaultStackAlignment() const;
    ///<summary> 
    ...
    /// Returns Acad::eInvalidInput if the operation fails.
    /// </returns>
    ACDB_PORT Acad::ErrorStatus    setDefaultStackAlignment(AcDbTextEditorSelectionBase::FlowAlign alignment);
...
protected:
    ACDB_PORT AcDbTextEditor():m_pImp(NULL) {};
    ACDB_PORT virtual ~AcDbTextEditor();

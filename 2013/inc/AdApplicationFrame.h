...
public:
    ...
    /// name will be blank if the user is not logged in or if the  
    /// function is called too early, before setting the cache  
    /// path.</summary> 
    ...
    /// <param name="size">Size of the buffer in characters.</param>
    /// <returns>The number of characters copied to the buffer if name 

...
/// the datbase.  Consuming applications should consider this object to be a
...
public:
    ...
    enum ScaleEstimationMethod {
        ...
        /// <summary>
        /// This algorithm corrects for grid scale distrotion by evaluating
    ...
    /// </summary>
    ACDB_PORT TypeOfCoordinates coordinateType() const;
    ACDB_PORT Acad::ErrorStatus setCoordinateType(TypeOfCoordinates designCoordinateType);
    ...
    /// </summary>
    ACDB_PORT AcGePoint3d designPoint() const;
    ACDB_PORT Acad::ErrorStatus setDesignPoint(const AcGePoint3d& point);
    ...
    /// </summary>
    ACDB_PORT AcGePoint3d referencePoint() const;
    ACDB_PORT Acad::ErrorStatus setReferencePoint(const AcGePoint3d& point);
    ...
    /// </summary>
    ACDB_PORT double horizontalUnitScale() const;
    ACDB_PORT AcDb::UnitsValue horizontalUnits () const;
    ACDB_PORT Acad::ErrorStatus setHorizontalUnitScale(double horzUnitScale);
    ACDB_PORT Acad::ErrorStatus setHorizontalUnits (AcDb::UnitsValue horizUnits);
    ...
    /// Default = 1.0 (i.e. meters)
    /// </summary>
    ACDB_PORT double verticalUnitScale() const;
    ACDB_PORT AcDb::UnitsValue verticalUnits () const;
    ACDB_PORT Acad::ErrorStatus setVerticalUnitScale(double vertUnitScale);
    ACDB_PORT Acad::ErrorStatus setVerticalUnits(AcDb::UnitsValue vertUnits);
    ...
    /// form.  Apart from filing in and out the content of the string to
    /// the Autocad DWG and DXF files, Autocad doesn’t handle the content
    /// of this string directly and no validation is executed on it.
    /// The purpose of this coordinate system string is to provide
    /// interoperability between Autocad and vertical applications that have
    /// access to a coordinate system library.
    /// The format and value of this string is to be defined by the Autocad
    /// vertical that will leverage this API. Such vertical application can
    /// register the callback method setValidateCoordinateSystemCallback
    /// to validate this string. As an example, a possible format for the
    /// string expression of the coordinate system definition could be WKT.
    /// In the absence of this validation callback function setCoordinateSystem
    /// will always return eOk.
    /// Default = null string.
    /// </summary>
    ACDB_PORT const ACHAR* coordinateSystem() const;
    ACDB_PORT Acad::ErrorStatus setCoordinateSystem(const ACHAR* coordinateSystem);
    ...
    /// </summary>
    static ACDB_PORT Acad::ErrorStatus setValidateCoordinateSystemCallback(ACDBGEODATA_VALIDATE_CS pFuncValidateCs);
    static ACDB_PORT ACDBGEODATA_VALIDATE_CS getValidateCoordinateSystemCallback();
    ...
    /// Defult = (0,1);
    /// </summary>
    ACDB_PORT double northDirection() const;            // radians
    ACDB_PORT AcGeVector2d northDirectionVector() const;
    ACDB_PORT Acad::ErrorStatus setNorthDirectionVector(const AcGeVector2d& north);
    ...
    /// </summary>
    ACDB_PORT ScaleEstimationMethod scaleEstimationMethod() const;
    ACDB_PORT Acad::ErrorStatus setScaleEstimationMethod(ScaleEstimationMethod value);
    ...
    /// Default = false;
    /// </summary>
    ACDB_PORT bool doSeaLevelCorrection() const;
    ACDB_PORT Acad::ErrorStatus setDoSeaLevelCorrection(bool seaLevelCorrectionOn);
    ...
    /// Default = NAN
    /// </summary>
    ACDB_PORT double seaLevelElevation() const;
    ...
    /// </summary>
    ACDB_PORT double coordinateProjectionRadius() const;
    ...
    ACDB_PORT Acad::ErrorStatus setGeoRSSTag(const ACHAR* rssTag);
    ...
    ACDB_PORT Acad::ErrorStatus setObservationFrom(const ACHAR* from);

    // Geospatial (currently) has no requirements with regard to these members.
    ACDB_PORT const ACHAR* observationTo() const;
    ACDB_PORT Acad::ErrorStatus setObservationTo(const ACHAR* to);

    // Geospatial (currently) has no requirements with regard to these members.
    ACDB_PORT const ACHAR* observationCoverage() const;
    ACDB_PORT Acad::ErrorStatus setObservationCoverage(const ACHAR* coverage);
    ...
    ACDB_PORT Acad::ErrorStatus getMeshPointMap(int index, AcGePoint2d& sourcePt, AcGePoint2d& destPt) const;
    ACDB_PORT Acad::ErrorStatus getMeshPointMaps(AcGePoint2dArray& sourcePts, AcGePoint2dArray& destPts) const;
    ACDB_PORT Acad::ErrorStatus addMeshPointMap(int index, const AcGePoint2d& sourcePt, const AcGePoint2d& destPt);
    ACDB_PORT Acad::ErrorStatus setMeshPointMaps(const AcGePoint2dArray& sourcePts, const AcGePoint2dArray& destPts);
    ...
    ACDB_PORT Acad::ErrorStatus getMeshFace(int faceIndex, int& p0, int& p1, int& p2) const;
    ACDB_PORT Acad::ErrorStatus addMeshFace(int faceIndex, int p0, int p1,int p2);
    ...
    /// </summary>
    static ACDB_PORT Acad::ErrorStatus setTransformCallbacks(const ACHAR* zoneDescription,
                                                             ACDBGEODATA_GEOGRAPHICTODWG pFuncGeoToDwg,
                                                             ACDBGEODATA_DWGTOGEOGRAPHIC pFuncDwgToGeo);
    static ACDB_PORT const ACHAR* getTransformCallbacks(ACDBGEODATA_GEOGRAPHICTODWG& pFuncGeoToDwg,
                                                        ACDBGEODATA_DWGTOGEOGRAPHIC& pFuncDwgToGeo);
...
// Insertion method.
ACDB_PORT Acad::ErrorStatus acdbGetGeoDataTransform(AcDbDatabase*   pDbSource,

...
public:
    ...
    ACDB_PORT Acad::ErrorStatus  setWidth(double width);

    ACDB_PORT Acad::ErrorStatus  width(double& width) const;

    ACDB_PORT Acad::ErrorStatus  setHeight(double width);

    ACDB_PORT Acad::ErrorStatus  height(double& width) const;

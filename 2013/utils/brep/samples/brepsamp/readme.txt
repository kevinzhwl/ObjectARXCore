...
---------------------------------------------------------------
 (C) Copyright 2001-2011 by Autodesk, Inc.
...
with the behaviour of various functions within acbr19.dll, and
to exemplify proper usage of the functions in an integrated
environment.  Please note that if you wish to use acbr19.dll in
your own application you must load it by using acrxDynamicLinker
as in the sample app because acbr19.dll is an ARX application

...
This sample demonstrates the use of AsdkHlrApi19.

The AsdkHlrApi19 module is there to help to calculate hidden lines 
...
To use these applications, AsdkHlrApi19.dbx should be copied into the 

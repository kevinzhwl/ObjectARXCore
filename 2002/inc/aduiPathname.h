...
#ifndef _aduiPathname_h
#define _aduiPathname_h
#pragma pack (push, 8)
...
virtual PathErr Parse( LPCTSTR, const BOOL wildcard_ok = FALSE );
        ...
        //  afterward.
        BOOL Open(FILE** fdp, const char *openmode);
...
virtual void AssignCopy( const CAdUiPathname& );
        ...
        static TCHAR GetLastCharacter( const CString& );

...
#define ACRX_CMD_NOPERSPECTIVE  0x00000008  // NOT allowed in perspective views
...
#define ACRX_CMD_NOMADIC        0x00040000
...
#define ACRX_CMD_SESSION           0x00200000  // Run cmd handler in the session fiber
...
public:
    ...
    virtual bool              atPut(const char* cmdGroupName,
    ...
    virtual AcEdCommand* lookupCmd(const char* cmdName,
                                   ...
                                   bool allGroupsFlag,
                                   bool skipUndefed) = 0;
    virtual AcEdCommand* lookupCmd2(const char* cmdName,
                                   bool globalFlag,
                                   bool allGroupsFlag,
                                   int skipFlags,
                                   bool match = false) = 0;

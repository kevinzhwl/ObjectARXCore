...
newBuffer(char *&pOutput, size_t size)
{ return acutNewBuffer(pOutput, size); }

inline Acad::ErrorStatus
newString(const char* pInput, char*& pOutput)
{ return acutNewString(pInput, pOutput); }

inline Acad::ErrorStatus
updString(const char* pInput, char*& pOutput)
{ return acutUpdString(pInput, pOutput); }

inline void
delString(char*& pString)
{ acutDelString(pString); }

inline void
delBuffer(char*& pString)
{ acutDelString(pString); }

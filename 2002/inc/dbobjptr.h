...
private:
    ...
    typedef T_OBJECT::RecordType T2;
};
...
//
// (AcDbObjectId objId, AcDb::OpenMode mode, bool openErased)
// (const char * name, AcDbDatabase * pDb,
...
public:
    ...
    AcDbSymbolTableRecordPointer(AcDbObjectId   objId,
                                 AcDb::OpenMode mode,
                                 bool           openErased = false);
    AcDbSymbolTableRecordPointer(const char *   name,
                                 AcDbDatabase * pDb,
                                 AcDb::OpenMode mode,
                                 bool           openErased = false);
...
AcDbObjectPointerBase<T_OBJECT>::AcDbObjectPointerBase<T_OBJECT>()
    : m_ptr(NULL),
...
template<class T_OBJECT> inline
AcDbObjectPointer<T_OBJECT>::AcDbObjectPointer<T_OBJECT>()
    : AcDbObjectPointerBase<T_OBJECT>()
{
}
...
template<class T_OBJECT> inline
AcDbSymbolTablePointer<T_OBJECT>::AcDbSymbolTablePointer<T_OBJECT>()
    : AcDbObjectPointerBase<T_OBJECT>()
{
}
...
AcDbSymbolTablePointer<T_OBJECT>::AcDbSymbolTablePointer<T_OBJECT>(
    AcDbObjectId   objId,
    AcDb::OpenMode mode)
    : AcDbObjectPointerBase<T_OBJECT>(objId, mode, Adesk::kFalse)
{
}

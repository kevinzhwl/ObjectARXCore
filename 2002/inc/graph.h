...
public:
    ...
    Adesk::Boolean	isMarkedAs	(Adesk::UInt8 flags) const;
    ...
    Adesk::Boolean	isCycleNode	() const;
...
private:
    ...
    void		setDirty	();
    Adesk::Boolean	mDirty;

};


class AcDbGraphStack
{
public:
...
inline Adesk::Boolean AcDbGraphNode::isMarkedAs(Adesk::UInt8 flag) const
    { return !!(mFlags & flag); }
...
inline Adesk::Boolean AcDbGraphNode::isCycleNode() const
...
inline Adesk::Boolean AcDbGraph::isEmpty() const 
    { return numNodes() == 0; }

inline void AcDbGraph::setDirty() { mDirty = Adesk::kTrue; }


// XreGraphStack inlines ...

inline Adesk::Boolean AcDbGraphStack::isEmpty() const

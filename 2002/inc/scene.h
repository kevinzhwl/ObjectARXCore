...
#define AD_SCENE_H
//
//  (C) Copyright 1986-1999 by Autodesk, Inc.  All rights reserved.
//
...
struct scn_pmsh {
    ...
    short  color;                     /* Face's surface property */
...
Acad::ErrorStatus acreEntityToFaces(ads_name ss, char** const name, int normal);

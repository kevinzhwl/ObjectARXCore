...
class ACUTXMLDOM_API AcUtXMLDOMEntity : public AcUtXMLDOMNode
{
public:
    AcUtXMLDOMEntity();
    AcUtXMLDOMEntity(const AcUtXMLDOMNode* pNode);
    virtual ~AcUtXMLDOMEntity();

    AcUtXMLDOMResult get_notationName(AcUtString& name) const;
...
protected:
    ...
    AcUtImpXMLDOMEntity* mpImpEntity;
};

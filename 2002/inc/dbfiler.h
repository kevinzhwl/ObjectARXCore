...
// 
{
  public:
    ...
    virtual Acad::ErrorStatus   readChar(char*) = 0;
    virtual Acad::ErrorStatus   writeChar(char) = 0;

    virtual Acad::ErrorStatus   readString(char**) = 0;
    virtual Acad::ErrorStatus   writeString(const char*) = 0;
    ...
    //
            ...
            Acad::ErrorStatus   readItem(char*);
            Acad::ErrorStatus   writeItem(char);

            Acad::ErrorStatus   readItem(char**);
            Acad::ErrorStatus   writeItem(const char*);
            ...
            Acad::ErrorStatus   readItem(void *, Adesk::UInt32);
            Acad::ErrorStatus   writeItem(const void *, Adesk::UInt32);

            Acad::ErrorStatus   readItem(void **);
            Acad::ErrorStatus   writeItem(const void *);


    virtual Acad::ErrorStatus   seek(long offset, int method) = 0;
    virtual              long   tell() const = 0;
    virtual Acad::ErrorStatus   addReferences(AcDbIdRefQueue& /*qToAbsorb*/);
    virtual              bool   usesReferences() const;

    virtual inline AcDbFilerController& controller() const;
...
class AcDbDxfFiler: public AcRxObject
{
public:
    ...
    virtual Acad::ErrorStatus setError(Acad::ErrorStatus, const char*, ...);
    virtual Acad::ErrorStatus setError(const char*, ...);
    ...
    virtual Acad::ErrorStatus writeChar    (AcDb::DxfCode, char) = 0;
    virtual Acad::ErrorStatus writeString  (AcDb::DxfCode, const char*) = 0;
    ...
    Acad::ErrorStatus writeItem (AcDb::DxfCode, char);
    Acad::ErrorStatus writeItem (AcDb::DxfCode, const char*);
    ...
    virtual bool              atEOF();
    virtual bool              atSubclassData(const char *);
    ...
    inline AcDbFilerController& controller() const;

private:
    AcDbFilerController& mController;
    virtual Acad::ErrorStatus setVAError(Acad::ErrorStatus, const char*, va_list);
};

inline        AcDbFilerController& AcDbDwgFiler::controller() const
{   return mController;    }
...
inline Acad::ErrorStatus AcDbDwgFiler::readItem(char* pVal)
{   return readChar(pVal);            }

inline Acad::ErrorStatus AcDbDwgFiler::writeItem(char val)
{   return writeChar(val);            }

inline Acad::ErrorStatus AcDbDwgFiler::readItem(char** pVal)
{   return readString(pVal);            }

inline Acad::ErrorStatus AcDbDwgFiler::writeItem(const char* val)
...
inline Acad::ErrorStatus AcDbDwgFiler::readItem(void *buf, Adesk::UInt32 cnt)
{   return readBytes(buf, cnt);     }

inline Acad::ErrorStatus 
AcDbDwgFiler::writeItem(const void *buf, Adesk::UInt32 cnt)
...
inline        AcDbFilerController& AcDbDxfFiler::controller() const
{   return mController;    }

inline void AcDbDxfFiler::setPrecision(int) {}

inline int AcDbDxfFiler::precision() const 
{ return (int)kDfltPrec; }
...
inline Acad::ErrorStatus
AcDbDxfFiler::writeItem(AcDb::DxfCode dc, char val)
{   return writeChar(dc, val);                }

inline Acad::ErrorStatus
AcDbDxfFiler::writeItem(AcDb::DxfCode dc, const char* val)

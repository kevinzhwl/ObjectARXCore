...
public:
    ...
    bool     isParallel (const Vector3d&) const;         // TODO Jiri Kripac: For DLL compatibility only
    ...
    bool     isPerpend  (const Vector3d&) const;         // TODO Jiri Kripac: For DLL compatibility only

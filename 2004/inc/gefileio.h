...
private:
    ...
    Acad::ErrorStatus readBool(AcGeFiler*, bool*,
                               const AcGeLibVersion&);
    static
    Acad::ErrorStatus writeLong(AcGeFiler*, long,
                             const AcGeLibVersion&);
    static
    Acad::ErrorStatus readLong(AcGeFiler*, long*,
                            const AcGeLibVersion&);
    static
    ...
    Acad::ErrorStatus writeBytes(AcGeFiler* filer, const void* buf,
                    unsigned long len, const AcGeLibVersion& version);
    static
    Acad::ErrorStatus readBytes(AcGeFiler* filer, void* buf,
                    unsigned long len, const AcGeLibVersion& version);

	friend class AcGeFileIOX;

...
class AcHeapOperators {
    private:
        static void * __fastcall allocRawMem(size_t size);
        static void * __fastcall allocRawMem(size_t size, const char *pFName,
                                             int nLine);
        static void   __fastcall freeRawMem(void *p);
        static void   __fastcall freeRawMem(void *p, const char *pFName,
                                            int nLine);
    public:

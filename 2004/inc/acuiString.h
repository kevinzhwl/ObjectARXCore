...
public:
        ...
        ADUI_PORT CAcUiString (char ch, int nRepeat = 1);
...
public:
        ...
        ADUI_PORT void    ReplaceCharWithChar (char chFrom, char chTo);
...
public:
        ...
        ADUI_PORT void    StripTrailingCharacters  (char cChar);
        ADUI_PORT void    StripPrecedingCharacters (char cChar);
...
public:
        ...
        ADUI_PORT CAcUiStringExp (char ch, int nRepeat = 1);

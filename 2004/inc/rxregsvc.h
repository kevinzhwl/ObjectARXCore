...
//
// (C) Copyright 1992-2002 by Autodesk, Inc.  All rights reserved.
//
...
//
bool ADESK_STDCALL acrxAppIsLoaded(const char *pAppName);
...
AcadApp::ErrorStatus acrxRegisterApp(AcadApp::LoadReasons alr,
        const char *logicalName, bool bDwgU = false);

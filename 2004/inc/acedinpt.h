...
// in the corresponding "ads_get*()" functions.  As far as apps are concerned,
...
//
// Note also that the ads_initget() parameters are folded into the beginGetXxx
...
public:
    ...
    // These two callbacks service both ads_nentsel() and ads_nentselp()
    ...
    // These two callbacks cover internal AutoCAD drag sequences, ads_draggen()

...
public:
    ...
    // DELOBJ
    Acad::ErrorStatus setDelUsedObj(bool, bool bUndo = false);
    inline bool delUsedObj() const;
...
// DELOBJS
inline bool AcDbAppSystemVariables::delUsedObj() const
{
    return m_delobj;
}

...
bool
c4ObjIdIsLessThan(unsigned long lhs, unsigned long rhs); 

bool
c4ObjIdIsGreaterThan(unsigned long lhs, unsigned long rhs); 

bool
c4ObjIdLessThanOrEqual(unsigned long lhs, unsigned long rhs); 

bool
c4ObjIdGreaterThanOrEqual(unsigned long lhs, unsigned long rhs); 

bool
c4ObjIdIsEqualTo(unsigned long lhs, unsigned long rhs); 

bool
c4ObjIdNotEqualTo(unsigned long lhs, unsigned long rhs); 

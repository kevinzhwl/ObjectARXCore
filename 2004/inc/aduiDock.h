...
#define ADUI_XML_ROOT                   "AdUiTools"
#define ADUI_XML_DOCK_TOOL_INFO         "ToolsInfo"
#define ADUI_XML_DOCK_TOOL              "Tool"
#define ADUI_XML_DOCK_TOOL_CLSID        "CLSID"
#define ADUI_XML_DOCK_STARTUP_INFO      "StartupInfo"
#define ADUI_XML_DOCK_STARTUP_TOOL_NAME "ToolName"
#define ADUI_XML_DOCK_STARTUP_CMD_NAME  "Command"
...
private:
    ...
    void    doDrawButton(CDC *pdc, AdUiSkBtnItems btnItem, BOOL erase = false);
    void    doDrawBorder();
...
void GetSystemVirtualScreen(RECT &rect);        // INTERNAL USE ONLY

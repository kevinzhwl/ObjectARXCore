...
// symbol type for AcGiGeometry::symbol(..)
typedef enum {
    kAcGiGrip,
} AcGiSymbolType;
...
class AcGiWorldGeometry2: public AcGiWorldGeometry
{
public:
    ACRX_DECLARE_MEMBERS(AcGiWorldGeometry2);

    virtual void pushPositionTransform (AcGiPositionTransformBehavior behavior, const AcGePoint2d& offset) = 0; 

    virtual void pushScaleTransform(AcGiScaleTransformBehavior behavior, const AcGePoint2d& extents) = 0; 

    virtual void pushOrientationTransform(AcGiOrientationTransformBehavior behavior) = 0;
...
class AcGiViewportGeometry2: public AcGiViewportGeometry
{
public:
    ACRX_DECLARE_MEMBERS(AcGiViewportGeometry2);

...
/* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE IAcadToolProperties2_get_ItemOption_Proxy( 
    IAcadToolProperties2 * This,
    /* [retval][out] */ LONG *pItemOption);


void __RPC_STUB IAcadToolProperties2_get_ItemOption_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
/* [helpstring][id][propput] */ HRESULT STDMETHODCALLTYPE IAcadToolProperties2_put_ItemOption_Proxy( 
    IAcadToolProperties2 * This,
    /* [in] */ LONG lItemOption);


void __RPC_STUB IAcadToolProperties2_put_ItemOption_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
/* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE IAcadToolProperties2_get_ImageOption_Proxy( 
    IAcadToolProperties2 * This,
    /* [retval][out] */ LONG *pImageOption);


void __RPC_STUB IAcadToolProperties2_get_ImageOption_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
/* [helpstring][id][propput] */ HRESULT STDMETHODCALLTYPE IAcadToolProperties2_put_ImageOption_Proxy( 
    IAcadToolProperties2 * This,
    /* [in] */ LONG lImageOption);


void __RPC_STUB IAcadToolProperties2_put_ImageOption_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
/* [helpstring][id] */ HRESULT STDMETHODCALLTYPE IAcadTool2_UpdateImage_Proxy( 
    IAcadTool2 * This);


void __RPC_STUB IAcadTool2_UpdateImage_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);

...
Visual Studio 2005 is unable to add Method/Property elements to an ObjectARX 
...
(See C:\Program Files\Microsoft Visual Studio 8\VC\VCWizards\1033\common.js line # 2200)
...
B) Autodesk Class Explorer fails to launch wizards.
---------------------------------------------------

Under certain conditions the Autodesk Class Explorer may fail to launch some wizards.
We are working on fixing the issue, and the fix will be available via LiveUpdate. 
In the meantime, you can work around the issue by launching the Wizards either 
from the MS Class Explorer or the Project Explorer.

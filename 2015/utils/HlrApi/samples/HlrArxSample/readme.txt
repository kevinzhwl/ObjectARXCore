...
This sample demonstrates the use of AsdkHlrApi20.

The AsdkHlrApi20 module is there to help to calculate hidden lines 
...
To use these applications, AsdkHlrApi20.dbx should be copied into the 

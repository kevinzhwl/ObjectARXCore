...
#ifdef _AFXEXT
	#pragma comment (lib ,"acui20.lib")
	#pragma comment (lib ,"adui20.lib")
...
#pragma comment (lib ,"AcFdEval.lib")
	...
	#pragma comment (lib ,"aseapi20.lib")
	#pragma comment (lib ,"asiapi20.lib")
#else
	#pragma comment (lib ,"aseapi20d.lib")
	#pragma comment (lib ,"asiapi20d.lib")
#endif

...
#define END_PERPROPDISPLAY_MAP2()                                                            \
        {-1, NULL, NULL, PICTYPE_UNINITIALIZED, NULL, PICTYPE_UNINITIALIZED, TEXTCOLOR_DEFAULT, false, -1, -1}\
        };                                                                                    \
...
public:
                        ...
                        LPWSTR pszValue)
    {
        ...
        //TODO: FIXME IN GATOR, We can't change the API due to binary compatibilty
        //in this release so we are just supressing this error.
#pragma warning (push)

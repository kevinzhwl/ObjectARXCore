...
public:
    ...
    ACDB_PORT virtual Acad::ErrorStatus  getAcGeCurve ( AcGeCurve3d*& pGeCurve,
    ...
    /// <param name="tol">Optional input tolerance.</param>
    /// <returns>Returns eOk if successful.</returns>
    ACDB_PORT static  Acad::ErrorStatus  createFromAcGeCurve ( const AcGeCurve3d& geCurve, AcDbCurve*& pDbCurve,
    ...
    /// <param name="tol">Optional input tolerance.</param>
    /// <returns>Returns eOk if successful.</returns>
    ACDB_PORT virtual Acad::ErrorStatus  setFromAcGeCurve ( const AcGeCurve3d& geCurve,
                                                            AcGeVector3d *normal = NULL,
                                                            const AcGeTol& tol = AcGeContext::gTol );

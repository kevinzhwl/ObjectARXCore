...
/// </description>
class AcRxQueryXOverrule : public AcRxOverrule
{
public:
    ...
    /// Default Constructor.
    /// </description>
    ACBASE_PORT AcRxQueryXOverrule();
    ...
    /// </remarks>
    ACBASE_PORT virtual AcRxObject* queryX(const AcRxObject* pSubject, const AcRxClass* protocolClass) const;
};
#pragma warning( pop ) 

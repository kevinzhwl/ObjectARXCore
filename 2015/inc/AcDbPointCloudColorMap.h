...
friend AcRxObject * makeAcDbPointCloudColorMap();
...
public:
    ...
    /// <returns> Returns true upon success. </returns>
    bool                            colorScheme(const TCHAR* GUID, AcDbPointCloudColorRamp& target) const;
    ...
    bool                            hasColorScheme(const TCHAR* GUID) const;
    ...
    /// <returns> Returns true upon success. </returns>
    bool                            setColorScheme(const TCHAR* GUID, const AcDbPointCloudColorRamp& source);
    ...
    /// <param name="GUID">The color scheme's GUID.</param>
    /// <returns> Returns true upon success. </returns>
    bool                            deleteColorScheme(const TCHAR* GUID);
    ...
    /// <param name="target">The color ramp definition.</param>
    /// <returns> Returns true upon success. </returns>
    bool                            classificationScheme(const TCHAR* GUID, AcDbPointCloudClassificationColorRamp& target) const;
    ...
    /// <param name="GUID">The color scheme's GUID.</param>
    /// <returns> Returns true if the color scheme exists. </returns>
    bool                            hasClassificationScheme(const TCHAR* GUID) const;
    ...
    /// <param name="source">The color ramp definition.</param>
    /// <returns> Returns true upon success. </returns>
    bool                            setClassificationScheme(const TCHAR* GUID, const AcDbPointCloudClassificationColorRamp& source);
    ...
    /// <param name="GUID">The color scheme's GUID.</param>
    /// <returns> Returns true upon success. </returns>
    bool                            deleteClassificationScheme(const TCHAR* GUID);

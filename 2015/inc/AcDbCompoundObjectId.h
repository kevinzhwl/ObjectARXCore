...
/// </summary>
///
class ACDB_PORT AcDbParentTransformOfChildPE : public AcRxObject
{
public:
    ...
    /// </summary>
    ///
    virtual Acad::ErrorStatus getParentTransformOfChild(const AcDbObject* pThisParent, const AcDbObjectId& childId, AcGeMatrix3d&) = NULL;
};

...
public:
    ...
    /// <summary> 
    /// Draw current image resource that is scaled based on its DPI and the screen DPI.
    /// </summary>
    /// <param name="pDC"> 
    /// Specify DC that used to draw image resource.
    /// </param>
...
private:
    ...
    void clear();
    bool drawImage(Gdiplus::Graphics & graphics, int x, int y, int width, int height, bool isDisabled);

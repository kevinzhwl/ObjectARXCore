...
#pragma comment (lib ,"acdb20.lib")
#pragma comment (lib ,"acge20.lib")
#pragma comment (lib ,"acISMobj20.lib")
#pragma comment (lib ,"acgiapi.lib")
#pragma comment (lib ,"axdb.lib")
#pragma comment (lib ,"ac1st20.lib") 
#ifdef _DBX_HOST_APPLICATION_
	#pragma comment (lib ,"acurlutl20.lib")
#endif // _DBX_HOST_APPLICATION_
#ifdef _BREP_SUPPORT_
	#pragma comment (lib ,"acgex20.lib")
	#pragma comment (lib ,"acbr20.lib")
#endif // _BREP_SUPPORT_
#else // AC_FULL_DEBUG
#pragma comment (lib ,"rxapi.lib")
#pragma comment (lib ,"acdb20d.lib")
#pragma comment (lib ,"acge20d.lib")
#pragma comment (lib ,"acISMobj20d.lib")
#pragma comment (lib ,"acgiapi.lib")
#pragma comment (lib ,"axdb.lib")
#pragma comment (lib ,"ac1st20d.lib") 
#ifdef _DBX_HOST_APPLICATION_
	#pragma comment (lib ,"acurlutl20d.lib")
#endif // _DBX_HOST_APPLICATION_
#ifdef _BREP_SUPPORT_
	#pragma comment (lib ,"acgex20d.lib")
	#pragma comment (lib ,"acbr20d.lib")
#endif // _BREP_SUPPORT_
#endif // AC_FULL_DEBUG

#ifdef _HLR_SUPPORT_
	#pragma comment (lib ,"AsdkHlrApi20.lib")
#endif

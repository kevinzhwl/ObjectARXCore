...
public:
    ...
    /// <summary>
    /// Gets if the image in drawn at the center of the button
    /// </summary>
    /// <returns>
    /// True if the the image in drawn at the center of the button or false otherwise
    /// </returns>
    BOOL CenterImage() const;

    /// <summary>
    /// Sets if the image in drawn at the center of the button
    /// </summary>
    /// <param name="center">
    /// True if the the image in drawn at the center of the button or false otherwise
    /// </param>

...
public:
    ...
    /// <returns>Returns Acad::eOk if successful.</returns>
    ///
    ACDB_PORT static Acad::ErrorStatus createAll(AcArray<AcDbGeoCoordinateSystemCategory*>& allCategories);
};
...
public:
    ...
    /// If the CRS is geographic, this value represents the distance in meters of 1°
    ...
    /// <returns>Returns Acad::eOk if successful.</returns>
    ///
    ACDB_PORT static Acad::ErrorStatus create(const AcString& coordSysIdOrFullDef, 
    ...
    /// <returns>Returns Acad::eOk if successful.</returns>
    ///
    ACDB_PORT static Acad::ErrorStatus createAll(const AcGePoint3d& geoPt,
    ...
    /// <returns>Returns Acad::eOk if successful.</returns>
    ///
    ACDB_PORT static Acad::ErrorStatus createAll(AcArray<AcDbGeoCoordinateSystem*>& allCoordSys,
...
public:
    ...
    /// <returns>Returns Acad::eOk if successful.</returns>
    ///
    ACDB_PORT static Acad::ErrorStatus transformPoint(const AcString& sourceCoordSysId,
    ...
    /// <returns>Returns Acad::eOk if successful.</returns>
    ///
    ACDB_PORT static Acad::ErrorStatus transformPoints(const AcString& sourceCoordSysId,
                                                       const AcString& targetCoordSysId,
    ...
    /// <returns>Returns Acad::eOk if successful.</returns>
    ///
    ACDB_PORT static Acad::ErrorStatus create(const AcString& sourceCoordSysId, 
                                              const AcString& targetCoordSysId,

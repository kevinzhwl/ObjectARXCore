...
ADESK_FORCE_INLINE void AcGeTol::setEqualVector( double val )
    { mTolArr[1] = val; }

ADESK_FORCE_INLINE double AcGeTol::equalVector() const
    { return mTolArr[1]; }

ADESK_FORCE_INLINE void AcGeTol::setEqualPoint( double val )
    { mTolArr[0] = val; }

ADESK_FORCE_INLINE double AcGeTol::equalPoint() const
    { return mTolArr[0]; }

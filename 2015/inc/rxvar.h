...
public:
    ...
    ///if the variable does not exist</returns>
    ACDB_PORT static bool getBool(const AcRxVariable* pVar, bool def);
    ...
    ///<returns>Returns Acad::eOk if sucessful. Acad::eNotApplicable when the variable has a different owner. Other Acad::ErrorStatus values for 
    ///other failures.</returns>
    ACDB_PORT static Acad::ErrorStatus setBool(AcRxVariable*, bool val);
    ...
    ///<returns>Returns the Int16 value stored in the named variable of <paramref name='def'/> 
    ///if the variable does not exist</returns>
    ACDB_PORT static short getInt16(const AcRxVariable* pVar, short def);
    ...
    ///<returns>Returns Acad::eOk if sucessful. Acad::eNotApplicable when the variable has a different owner. Other Acad::ErrorStatus values for 
    ///other failures.</returns>
    ACDB_PORT static Acad::ErrorStatus setInt16(AcRxVariable* pVar, short val);
    ...
    ///<returns>Returns the double value stored in the named variable of <paramref name='def'/> 
    ///if the variable does not exist</returns>
    ACDB_PORT static double getDouble(const AcRxVariable* pVar, double def);
    ...
    ///<returns>Returns Acad::eOk if sucessful. Acad::eNotApplicable when the variable has a different owner. Other Acad::ErrorStatus values for 
    ///other failures.</returns>
    ACDB_PORT static Acad::ErrorStatus setDouble(AcRxVariable* pVar, double val);
    ...
    ///<returns>Returns the AcString value stored in the named variable of 
    ///if the variable does not exist. The function will return NULL if there's no sysvar with this name</returns>
    ACDB_PORT static AcString getString(const AcRxVariable* pVar);
    ...
    ///<returns>Returns Acad::eOk if sucessful. Acad::eNotApplicable when the variable has a different owner. Other Acad::ErrorStatus values for 
    ///other failures.</returns>
    ACDB_PORT static Acad::ErrorStatus setString(AcRxVariable* pVar, const ACHAR* val);

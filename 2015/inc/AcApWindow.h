...
public:
    ...
    /// </remarks>
    ACCORE_PORT bool  preRouteMessage(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam, LONG_PTR& lResult);
    ...
    /// </remarks>
    ACCORE_PORT bool     routeMessage(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam, LONG_PTR& lResult);
    ...
    /// the same message
    /// </remarks>
    ACCORE_PORT bool postRouteMessage(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam, LONG_PTR& lResult);
...
protected:
    ...
    /// </remarks>
    ACCORE_PORT virtual bool subPreRouteMessage(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam, LONG_PTR& lResult);
    ...
    /// </remarks>
    ACCORE_PORT virtual bool subRouteMessage(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam, LONG_PTR& lResult);
    ...
    /// </remarks>
    ACCORE_PORT virtual bool subPostRouteMessage(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam, LONG_PTR& lResult);

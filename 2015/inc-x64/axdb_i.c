...
MIDL_DEFINE_GUID(IID, LIBID_AXDBLib,0x594E795C,0x1019,0x46CC,0x96,0x9B,0x12,0x1B,0xE0,0x89,0x17,0xB2);
...
MIDL_DEFINE_GUID(IID, IID_IAxDbDocumentEvents,0x05BE1EA2,0xA071,0x4251,0x9F,0xD2,0x6B,0xCA,0x16,0x1C,0xFC,0xD3);


MIDL_DEFINE_GUID(IID, IID_IAxDbDocument,0xB4F4A731,0xD9EA,0x403C,0xAD,0xD4,0xB1,0x66,0xBA,0x06,0x03,0x5C);

...
/// </summary>
///
struct AcConstrainedGeometryDraggingInfo : AcDbAssocTransInfo
{
  /// <summary>
  ...
  /// </summary>
  ///
  ACDB_PORT static const AcString& getKey();
};
...
public:
  ...
  /// Input AcConstraintGroupNodeId indicating the constrained curve to which
  ...
  /// </param>
  ///
  AcConstrainedImplicitPoint(AcConstraintGroupNodeId constrCurvId,ImplicitPointType ptype, int index = -1);
  ...
  /// <summary> 
  /// Returns AcConstraintGroupNodeId of the constrained curve to which
  /// this implicit point belongs.
  /// </summary>
  /// <returns> AcConstraintGroupNodeId. </returns>
  ///
  AcConstraintGroupNodeId constrainedCurveId() const;
...
public:
  ...
  /// </param>
  ///
  AcConstrained2PointsConstructionLine(const AcGePoint3d& point1, const AcGePoint3d& point2);
};
...
public:
  ...
  /// </param>
  ///
  AcConstrainedDatumLine(const AcGePoint3d& pointOnLine, const AcGeVector3d& direction);
};
...
public:
  ...
  /// </param>
  ///
  AcConstrainedBoundedLine(AcDbObjectId geomDependencyId, bool bRay);
...
public:
  ...
  /// </param>
  ///
  AcConstrainedCircle(AcDbObjectId geomDependencyId);
...
public:
  ...
  /// </param>
  ///
  AcConstrainedArc(AcDbObjectId geomDependencyId);
...
public:
  ...
  /// </param>
  ///
  AcConstrainedEllipse(bool bCreateImp = true); 
  ...
  /// </param>
  ///
  AcConstrainedEllipse(AcDbObjectId geomDependencyId);
...
public:
  ...
  /// </param>
  ///
  AcConstrainedBoundedEllipse(AcDbObjectId geomDependencyId);
...
public:
  ...
  /// </param>
  ///
  AcConstrainedSpline(AcDbObjectId geomDependencyId, const AcGeNurbCurve3d& spline);
...
public:
  ...
  /// </param>
  ///
  AcConstrainedRigidSet(bool bScalable, const AcGeMatrix3d& trans);

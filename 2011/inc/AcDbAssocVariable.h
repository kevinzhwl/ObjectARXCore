...
public:     
    ...
    {
        AcString errorMsg;
        return setExpression(newExpression, evaluatorId, checkForCyclicalDependencies,updateDependenciesOnReferencedSymbols,
                             errorMsg, false);
    }
#endif    
...
ACDB_PORT void stringDefaultArgumentTest(AcString& str = dummyString());

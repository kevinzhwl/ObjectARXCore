...
/// </para> </summary>
///
class ACDB_PORT AcDbAssocEvaluationCallback
{
public:
    ...
    ///
    virtual void beginActionEvaluation(AcDbAssocAction* pAction) = NULL;
    ...
    /// <param name="pAction"> The action that is being evaluated. </param>
    ///
    virtual void endActionEvaluation(AcDbAssocAction* pAction) = NULL;
    ...
    beginActionEvaluationUsingObject(AcDbAssocAction*    pAction, 
                                     ...
                                     AcDbObject*&        pSubstituteObject) = NULL;
...
/// </summary>
///
class ACDB_PORT AcDbActionsToEvaluateCallback
{
public:
    /// <summary> Default constructor. </summary>
...
/// </para> </summary>
///
enum ACDB_PORT AcDbAssocCreateImpObject 
{

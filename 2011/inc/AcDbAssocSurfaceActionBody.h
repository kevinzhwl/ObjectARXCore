...
public: 
    ...
    /// <summary> Overridden implementation of the base class method. </summary>
    ///
    virtual Acad::ErrorStatus getDependentActionsToEvaluateOverride(AcDbActionsToEvaluateCallback*) const;

    /// <summary> Overridden implementation of the base class method. </summary>
    ///
    virtual Acad::ErrorStatus addMoreObjectsToDeepCloneOverride(
        AcDbIdMapping&, AcDbObjectIdArray& additionalObjectsToClone) const;

    /// <summary> Overridden implementation of the base class method. </summary>
    ///
    virtual Acad::ErrorStatus dragStatusOverride(const AcDb::DragStat);

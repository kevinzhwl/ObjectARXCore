...
public:
    ...
    AcDb2dPolyline (
        ...
        AcArray<Adesk::Int32>* vertexIdentifiers = NULL
        );
...
public:                
    ...
    ACDB_PORT virtual Adesk::Boolean      isPlanar() const;
    ACDB_PORT virtual Acad::ErrorStatus   getPlane(AcGePlane& plane, AcDb::Planarity& planarity) const;

...
public:
    ...
    enum HardwareFeature {
        ...
        kHwPhong,
        kHw2DHwAcceleration, // deprecated, use kHwAcceleration instead
        kHwDisable2DPreClip, // deprecated
        kHwAdvancedMaterials,
        kHwFeatures
    };
...
public:
    ...
    virtual void                viewToBeUpdated             (AcGsView * pView, 
                                                             int viewUpdateflags) { }
	virtual void                viewWasUpdated              (AcGsView * pView,
                                                             int viewUpdateflags) { }
...
public:
    ...
    virtual void                addModelReactor     (AcGsModel        * pModel,
                                                     AcGsModelReactor * pReactor)   = 0;
    virtual void                removeModelReactor  (AcGsModel        * pModel,
                                                     AcGsModelReactor * pReactor)   = 0;
};

...
#ifdef ASCII_OVERRIDE // only VLISP on the Mac defines this...
// MAC/VLisp oddness:  including adeskabb.h s gumming up VLISP on the Mac,
// all other contexts are fine with it.
typedef enum
	{
		kTrue                   = Adesk::kTrue,
		kFalse                  = Adesk::kFalse
...
#else // !ASCII_OVERRIDE
#include "adeskabb.h"
#endif // !ASCII_OVERRIDE
#endif // Adesk_Boolean_is_bool
...
#ifndef _MSC_VER
            Acad::ErrorStatus   writeItem(const AcString &);
            Acad::ErrorStatus   writeItem(const CString &);
#endif
...
#else
            Acad::ErrorStatus   writeItem(Adesk::BooleanVal);
            Acad::ErrorStatus   writeItem(AdBooleanVal);
#endif // Adesk_Boolean_is_bool
...
#ifndef _MSC_VER    	
    Acad::ErrorStatus writeItem (AcDb::DxfCode, const AcString &);
    Acad::ErrorStatus writeItem (AcDb::DxfCode, const CString &);
#endif
...
#else
    Acad::ErrorStatus writeItem (AcDb::DxfCode, Adesk::BooleanVal);
    Acad::ErrorStatus writeItem (AcDb::DxfCode, AdBooleanVal);
#endif
...
#else
inline Acad::ErrorStatus   AcDbDwgFiler::writeItem(Adesk::BooleanVal val)
{    return writeBool(val);             }

inline Acad::ErrorStatus   AcDbDwgFiler::writeItem(AdBooleanVal val)
{    return writeBool(val);             }
...
#else
inline Acad::ErrorStatus 
AcDbDxfFiler::writeItem (AcDb::DxfCode dc, Adesk::BooleanVal val)
{    return writeBoolean(dc, val);      }

inline Acad::ErrorStatus 
AcDbDxfFiler::writeItem (AcDb::DxfCode dc, AdBooleanVal val)
{    return writeBoolean(dc, val);      }
...
inline Acad::ErrorStatus AcDbDwgFiler::writeItem(const CString & val)
{   return writeString((const ACHAR*)val);            }
...
inline Acad::ErrorStatus
AcDbDxfFiler::writeItem(AcDb::DxfCode dc, const CString & val)
{   return writeString(dc, (const ACHAR*)val);        }

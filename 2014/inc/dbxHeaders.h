...
#pragma comment (lib ,"acdb19.lib")
#pragma comment (lib ,"acge19.lib")
#pragma comment (lib ,"acISMobj19.lib")
#pragma comment (lib ,"acgiapi.lib")
#pragma comment (lib ,"axdb.lib")
#pragma comment (lib ,"ac1st19.lib") 
#ifdef _HLR_SUPPORT_
	#pragma comment (lib ,"AsdkHlrApi19.lib")
#endif
#ifdef _DBX_HOST_APPLICATION_
	#pragma comment (lib ,"acurlutl19.lib")
#endif // _DBX_HOST_APPLICATION_
#ifdef _BREP_SUPPORT_
	#pragma comment (lib ,"acgex19.lib")
...
#else // AC_FULL_DEBUG
#pragma comment (lib ,"rxapi.lib")
#pragma comment (lib ,"acdb19d.lib")
#pragma comment (lib ,"acge19d.lib")
#pragma comment (lib ,"acISMobj19d.lib")
#pragma comment (lib ,"acgiapi.lib")
#pragma comment (lib ,"axdb.lib")
#pragma comment (lib ,"ac1st19d.lib") 
#ifdef _HLR_SUPPORT_
	#pragma comment (lib ,"AsdkHlrApi19.lib")
#endif
#ifdef _DBX_HOST_APPLICATION_
	#pragma comment (lib ,"acurlutl19d.lib")
#endif // _DBX_HOST_APPLICATION_
#ifdef _BREP_SUPPORT_
	#pragma comment (lib ,"acgex19d.lib")
	#pragma comment (lib ,"acbr19d.lib")
#endif // _BREP_SUPPORT_
#ifdef _AMODELER_SUPPORT_
	#pragma comment (lib, "aecmodeler70d.lib")
#endif // _AMODELER_SUPPORT_
#pragma comment (lib, "acdbmgd.lib")
#endif // AC_FULL_DEBUG

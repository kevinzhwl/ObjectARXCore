...
public:
    ...
    virtual void            setGsNode(AcGsNode* pNode)  { AcGiDrawable::setGsNode(pNode); }
    virtual AcGsNode*       gsNode() const              { return AcGiDrawable::gsNode(); }
...
protected:
    ...
    //
    virtual Adesk::Boolean  subWorldDraw(AcGiWorldDraw*) {return Adesk::kFalse;};

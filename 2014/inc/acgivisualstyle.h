...
public:
   ...
   virtual bool             operator==             (const AcGiFaceStyle& style) const;
    ...
    /// </param>                               
    virtual void             setFaceModifiers       (Adesk::UInt32 nModifiers);
    /// <summary>
    ...
    /// </returns>
    virtual Adesk::UInt32    faceModifiers          (void) const;
    /// <summary>
...
public:
    ...
    /// </param>                               
    virtual void                setEdgeStyles           (Adesk::UInt32 nStyles);
    /// <summary>
    ...
    /// </returns>
    virtual Adesk::UInt32       edgeStyles              (void) const;
    /// <summary>
    ...
    /// </param>                               
    virtual void                setEdgeModifiers        (Adesk::UInt32 nModifiers);
    /// <summary>
    ...
    /// flags that are in effect.
    /// </returns>
    virtual Adesk::UInt32       edgeModifiers           (void) const;
    /// <summary>
    ...
    /// Returns JitterAmount enumeration representing the jitter amount in effect.
    /// </returns>
    virtual WiggleAmount        wiggleAmount            (void) const; 
...
public:
    ...
    /// </param>                               
    virtual void                setDisplaySettings     (Adesk::UInt32 nSettings);
    /// <summary>
    ...
    /// flags that are in effect.
    /// </returns>
    virtual Adesk::UInt32       displaySettings        (void) const;
    /// <summary>
...
public:
    ...
    ///
    /// </example>
    ACDB_PORT virtual bool      setTrait    (AcGiVisualStyleProperties::Property prop, 
                                             const AcString *pStr,

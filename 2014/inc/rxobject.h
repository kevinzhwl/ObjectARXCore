...
public:
    ...
    ACBASE_PORT virtual AcRxClass*        isA() const GCC_NO_VTABLE;
    
    ACBASE_PORT virtual AcRxObject*       clone() const GCC_NO_VTABLE;
    ACBASE_PORT virtual Acad::ErrorStatus copyFrom(const AcRxObject* other) GCC_NO_VTABLE;
    ACBASE_PORT virtual Adesk::Boolean    isEqualTo(const AcRxObject * other) const GCC_NO_VTABLE;
    ACBASE_PORT virtual AcRx::Ordering    comparedTo(const AcRxObject * other) const GCC_NO_VTABLE;
    
protected:
    // AcRxQueryXOverrule related
    friend class                          AcRxQueryXOverrule;
    ACBASE_PORT virtual AcRxObject*       subQueryX(const AcRxClass* protocolClass) const GCC_NO_VTABLE;

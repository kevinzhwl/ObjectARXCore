...
public:
    ...
    ACDB_PORT Acad::ErrorStatus   setUsingDefaultTextPosition(bool);
    ...
    ACDB_PORT double                centerMarkSize() const;
    ACDB_PORT Acad::ErrorStatus     prefix(AcString& sPrefix) const;
    ACDB_PORT Acad::ErrorStatus     setPrefix(const AcString&);
    ACDB_PORT Acad::ErrorStatus     suffix(AcString&) const;
    ACDB_PORT Acad::ErrorStatus     setSuffix(const AcString&);

    ACDB_PORT Acad::ErrorStatus     alternateSuffix(AcString&) const;
    ACDB_PORT Acad::ErrorStatus     setAlternateSuffix(const AcString&);
    ACDB_PORT Acad::ErrorStatus     alternatePrefix(AcString&) const;
    ACDB_PORT Acad::ErrorStatus     setAlternatePrefix(const AcString&);

    ACDB_PORT bool                  suppressAngularLeadingZeros() const;
    ACDB_PORT Acad::ErrorStatus     setSuppressAngularLeadingZeros(bool);

    ACDB_PORT bool                  suppressAngularTrailingZeros() const;
    ACDB_PORT Acad::ErrorStatus     setSuppressAngularTrailingZeros(bool);

    ACDB_PORT bool                  altSuppressZeroInches() const;
    ACDB_PORT Acad::ErrorStatus     setAltSuppressZeroInches(bool);
    ACDB_PORT bool                  altSuppressZeroFeet() const;
    ACDB_PORT Acad::ErrorStatus     setAltSuppressZeroFeet(bool);
    ACDB_PORT bool                  altSuppressTrailingZeros() const;
    ACDB_PORT Acad::ErrorStatus     setAltSuppressTrailingZeros(bool);

    ACDB_PORT bool                  altToleranceSuppressLeadingZeros() const;
    ACDB_PORT Acad::ErrorStatus     setAltToleranceSuppressLeadingZeros(bool);
    ACDB_PORT bool                  altToleranceSuppressZeroInches() const;
    ACDB_PORT Acad::ErrorStatus     setAltToleranceSuppressZeroInches(bool);

    ACDB_PORT bool                  altToleranceSuppressZeroFeet() const;
    ACDB_PORT Acad::ErrorStatus     setAltToleranceSuppressZeroFeet(bool);
    ACDB_PORT bool                  altToleranceSuppressTrailingZeros() const;
    ACDB_PORT Acad::ErrorStatus     setAltToleranceSuppressTrailingZeros(bool);

    ACDB_PORT bool                  suppressZeroFeet() const;
    ACDB_PORT Acad::ErrorStatus     setSuppressZeroFeet(bool);
    ACDB_PORT bool                  suppressTrailingZeros() const;
    ACDB_PORT Acad::ErrorStatus     setSuppressTrailingZeros(bool);
    ACDB_PORT bool                  suppressLeadingZeros() const;
    ACDB_PORT Acad::ErrorStatus     setSuppressLeadingZeros(bool);
    ACDB_PORT bool                  suppressZeroInches() const;
    ACDB_PORT Acad::ErrorStatus     setSuppressZeroInches(bool);

    ACDB_PORT bool                  altSuppressLeadingZeros() const;
    ACDB_PORT Acad::ErrorStatus     setAltSuppressLeadingZeros(bool);
    ACDB_PORT bool                  toleranceSuppressZeroFeet() const;
    ACDB_PORT Acad::ErrorStatus     setToleranceSuppressZeroFeet(bool);

    ACDB_PORT bool                  toleranceSuppressTrailingZeros() const;
    ACDB_PORT Acad::ErrorStatus     setToleranceSuppressTrailingZeros(bool);
    ACDB_PORT bool                  toleranceSuppressLeadingZeros() const;
    ACDB_PORT Acad::ErrorStatus     setToleranceSuppressLeadingZeros(bool);

    ACDB_PORT bool                  toleranceSuppressZeroInches() const;
    ACDB_PORT Acad::ErrorStatus     setToleranceSuppressZeroInches(bool);

    enum CenterMarkType   { kMark       = 0,
                            kLine       = 1,
                            kNone       = 2 };

    ACDB_PORT AcDbDimension::CenterMarkType centerMarkType() const;
protected:
    /// <summary>
...
public:
    ...
    ACDB_PORT Acad::ErrorStatus   setUsingXAxis(bool value);
    ACDB_PORT Acad::ErrorStatus   setUsingYAxis(bool value);
...
public:
    ...
    ACDB_PORT AcDbDimensionStyleOverrule();
    ...
    /// Returns object ID of the AcDbDimStyleTableRecord referenced by the dimension.
    /// </returns>
    ACDB_PORT virtual AcDbObjectId   dimensionStyle  (const AcDbDimension* pSubject);
    ...
    /// Returns Acad::eOk if operation is successful.
    /// </returns>
    ACDB_PORT virtual Acad::ErrorStatus   setDimensionStyle (AcDbDimension* pSubject,
    ...
    /// Returns Acad::eOk if operation is successful.
    /// </returns>
    ACDB_PORT virtual Acad::ErrorStatus   getDimstyleData   (const AcDbDimension* pSubject,
    ...
    /// Returns Acad::eOk if operation is successful.
    /// </returns>
    ACDB_PORT virtual Acad::ErrorStatus   setDimstyleData   (AcDbDimension* pSubject,
                                                             AcDbDimStyleTableRecord* pRecord);

...
#ifdef _AFXEXT
	#pragma comment (lib ,"acui19.lib")
	#pragma comment (lib ,"adui19.lib")
...
#pragma comment (lib ,"AcFdEval.lib")
	...
	#pragma comment (lib ,"aseapi19.lib")
	#pragma comment (lib ,"asiapi19.lib")
#else
	#pragma comment (lib ,"aseapi19d.lib")
	#pragma comment (lib ,"asiapi19d.lib")
#endif

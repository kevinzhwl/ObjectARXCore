...
#include <malloc.h> //for _STATIC_ASSERT
#include <memory.h> //for memcpy
#ifndef __GNUC__
#include <type_traits> //for std::tr1::remove_reference
#else
#include <tr1/type_traits> // Different include path inside GCC 
#endif
#include "acutasrt.h"
#include "rxclass.h"
...
inline void* operator new(size_t size, Storage* loc) { return loc;}

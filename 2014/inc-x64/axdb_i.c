...
MIDL_DEFINE_GUID(IID, IID_IAcadGeoPositionMarker,0x6B5CE951,0x235D,0x4756,0x8A,0xD9,0x12,0x72,0xB9,0xA1,0x57,0x5F);
...
MIDL_DEFINE_GUID(IID, IID_IAcadPointCloud2,0x2D8852AC,0xC758,0x430D,0x93,0x6F,0x5B,0x0A,0xE4,0x04,0x64,0x00);

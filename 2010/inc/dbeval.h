...
public:
    ...
    Acad::ErrorStatus setValue(AcDb::DxfCode groupcode, const double value);
    Acad::ErrorStatus setValue(AcDb::DxfCode groupcode, const short value);
    Acad::ErrorStatus setValue(AcDb::DxfCode groupcode, const long value);
    Acad::ErrorStatus setValue(AcDb::DxfCode groupcode, const AcString& value);
    Acad::ErrorStatus setValue(AcDb::DxfCode groupcode, const AcDbObjectId value);
    ...
    Acad::ErrorStatus getValue(long& value) const;
    Acad::ErrorStatus getValue(AcString& value) const;
    Acad::ErrorStatus getValue(AcDbObjectId& value, AcDbDatabase *pDb = NULL) const;
    Acad::ErrorStatus getValue(AcGePoint3d& value) const;

...
/// </para> </summary>
///
class ACDB_PORT AcDbAssocVariable : public AcDbAssocAction
{
public:     
    ...
    /// including checks for refrences to undefined symbols and for cyclic 
    ...
    Acad::ErrorStatus setExpression(const AcString& newExpression, 
                                    ...
                                    AcString& errorMessage = AcString(),
    ...
    Acad::ErrorStatus evaluateExpression(AcDbEvalVariant& evaluatedExpressionValue,
                                         AcString&        errorMessage = AcString()) const;
    ...
    /// </para> <para>
    /// Evaluates the expression based on the provided values of the refrenced 
...
public:
    ...
    ///</returns>
    ///
    virtual bool canBeErased(const AcDbAssocVariable* pVariable) = NULL;
    ...
    virtual Acad::ErrorStatus validateNameAndExpression(const AcDbAssocVariable* pVariable,
                                                        ...
                                                        const AcString&          expressionToValidate,
                                                        AcString&                errorMessage) = NULL;
};


/// <summary>
/// Concrete implementation of the AcDbAssocValueProviderPE AcRx protocol 
/// extension to obtain the value of an AcDbAssocVariable. It is atached to
/// AcDbAssocVariable class an used by AcDbAssocValueDependency.
/// </summary>
///
class AcDbAssocVariableValueProviderPE : public AcDbAssocValueProviderPE
{
public:
	ACRX_DECLARE_MEMBERS(AcDbAssocVariableValueProviderPE);

    /// <summary>
    /// Gets the value of the variable. The valueName is ignored because the
    /// variable provides only a single value.
    /// </summary>
...
}; // class AcDbAssocVariableValueProviderPE

...
/// </para> </summary>
///
class ACDB_PORT AcDbAssocPersSubentId : public AcRxObject
{
public:
    ...
    ///
    virtual AcDb::SubentType subentType(const AcDbEntity* pEntity) const = NULL;
    ...
    /// </returns>
    ///
    virtual int transientSubentCount(const AcDbEntity* pEntity) const;
    ...
    /// exactly the same subentity of the same entity. The base class 
    /// implementation just checks whether the classes of this and of the other
    /// AcDbAssocPersSubentId are identical.
    /// </summary>
    /// <param  name="pEntity"> 
    ...
    createObjectAndDwgInFields(AcDbDwgFiler*           pFiler, 
    ...
    /// <returns> Acad::ErrorStatus. </returns>
    ///
    virtual Acad::ErrorStatus audit(AcDbAuditInfo* pAuditInfo) { return Acad::eOk; }

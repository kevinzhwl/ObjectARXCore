...
public:
    ...
    /// <param name="pSubject">Pointer to an AcDbEntity that this overrule is 
    /// applied against.</param>
    /// <param name="kNullSubent">Input AcDbFullSubentPath that identifies the 
    ...
    /// protected virtual AcDbEntity::unhighlight method. 
    /// </remarks>
...
public:
    ...
    /// <returns>Returns Acad::eOk if successful.</returns>
    /// <remarks>
    /// The default implementation of AcDbHighlightOverrule::intersectWith calls 
    ...
    /// <returns>Returns Acad::eOk if successful.</returns>
    /// <remarks>
    /// The default implementation of AcDbHighlightOverrule::getGeomExtents calls 

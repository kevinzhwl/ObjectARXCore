...
/// </summary>
///
class AcGiShadowParameters2 : public AcGiShadowParameters
{
public:
    ACRX_DECLARE_MEMBERS(AcGiShadowParameters2);

              AcGiShadowParameters2 (void);
    explicit  AcGiShadowParameters2 (const AcGiShadowParameters& params);
    virtual  ~AcGiShadowParameters2 (void);

    bool operator==(const AcGiShadowParameters2& params) const;
...
/// </summary>
///
class AcGiPointLightTraits2 : public AcGiPointLightTraits
{
public:
    ACRX_DECLARE_MEMBERS(AcGiPointLightTraits2);
    ...
    /// The AcGiShadowParameters object that defines the way shadows are cast from this light.
    /// </param>
    virtual void setShadowParameters(const AcGiShadowParameters2& params) = 0;
    ...
    /// properties of this light.
    /// </param>
    virtual void shadowParameters(AcGiShadowParameters2& params) const = 0;
...
/// </summary>
///
class AcGiSpotLightTraits2 : public AcGiSpotLightTraits
{
public:
    ACRX_DECLARE_MEMBERS(AcGiSpotLightTraits2);
...
/// </summary>
///
class AcGiDistantLightTraits2 : public AcGiDistantLightTraits
{
public:
    ACRX_DECLARE_MEMBERS(AcGiDistantLightTraits2);
...
/// </summary>
///
class AcGiWebLightTraits : public AcGiPointLightTraits2
{
public:

...
public:
  ...
  /// </param>
  /// <param name="pPtType">
  /// Input pointer to AcConstrainedImplicitPoint::ImplicitPointType indicating the implicit
  ...
  Acad::ErrorStatus getConstrainedGeometry(const AcDbAssocGeomDependency* pGeomDependency,
                                           AcConstrainedGeometry*&   pConsGeom,
                                           AcConstrainedImplicitPoint::ImplicitPointType* pPtType = NULL,
                                           int defPtIndex = -1,
                                           bool bCreateArcLineMid = false);
  ...
  /// </summary>
  /// <param name="nodeId">
  /// Input AcConstraintGroupNodeId indicating the node id. 
  /// </param>
  /// <returns>Returns pointer to AcConstraintGroupNode if successful, otherwise NULL</returns>
  ///
  AcConstraintGroupNode* getGroupNodePtr(const AcConstraintGroupNodeId nodeId) const;

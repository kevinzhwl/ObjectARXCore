...
//  Inc., and considered a trade secret as defined in section 499C of the penal
//  code of the State of California.  Use of this information by anyone other
//  than authorized employees of Autodesk, Inc. is granted only under a written
...
public:
    ...
    ///
    AcDbAssocObjectPointer(AcDbAssocAction*               pActionBeingEvaluated, 

...
#pragma comment (lib ,"acdb18.lib")
#pragma comment (lib ,"acge18.lib")
#pragma comment (lib ,"acISMobj18.lib")
#pragma comment (lib ,"acgiapi.lib")
#pragma comment (lib ,"axdb.lib")
#ifdef _HLR_SUPPORT_
	#pragma comment (lib ,"AsdkHlrApi18.lib")
#endif
#ifdef _DBX_HOST_APPLICATION_
	#pragma comment (lib ,"acurlutl18.lib")
#endif // _DBX_HOST_APPLICATION_
#ifdef _BREP_SUPPORT_
	#pragma comment (lib ,"acgex18.lib")
...
#else // AC_FULL_DEBUG
#pragma comment (lib ,"rxapi.lib")
#pragma comment (lib ,"acdb18d.lib")
#pragma comment (lib ,"acge18d.lib")
#pragma comment (lib ,"acISMobj18d.lib")
#pragma comment (lib ,"acgiapi.lib")
#pragma comment (lib ,"axdb.lib")
#ifdef _HLR_SUPPORT_
	#pragma comment (lib ,"AsdkHlrApi18.lib")
#endif
#ifdef _DBX_HOST_APPLICATION_
	#pragma comment (lib ,"acurlutl18d.lib")
#endif // _DBX_HOST_APPLICATION_
#ifdef _BREP_SUPPORT_
	#pragma comment (lib ,"acgex18d.lib")
	#pragma comment (lib ,"acbr18d.lib")
#endif // _BREP_SUPPORT_
#ifdef _AMODELER_SUPPORT_
	#pragma comment (lib, "aecmodeler60d.lib")
#endif // _AMODELER_SUPPORT_
#pragma comment (lib, "acdbmgd.lib")
#endif // AC_FULL_DEBUG

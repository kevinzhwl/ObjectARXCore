...
/// </remarks>
///
class ACDB_PORT AcDbSubentGeometry
{
public:
...
public:
    ...
    ///
    virtual AcString getEntityTextOverride() const = NULL;
    ...
    ///
    virtual Acad::ErrorStatus setEntityTextOverride(const AcString& newText) = NULL;
    ...
    /// </para> <para> This API performs the following operations:
    /// </para> <para> 1. Moves the constraint geometry sub entity by the same 
    /// amount the dimension grip point has been moved.
    /// </para> <para> 2. Moves the constrained geometry at the opposite end of 
    ...
    /// </para> </para> 3. Updates the constraint variable value with new measurement.
    /// </para> </summary>

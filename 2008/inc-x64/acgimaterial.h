...
class AcGiMaterialTraits2 : public AcGiMaterialTraits
// 
// Extended material interface allowing for material traits
//
{
public:
    ACRX_DECLARE_MEMBERS(AcGiMaterialTraits2);
...
public:
    ...
    ADESK_DEPRECATED virtual void setTiling         (Tiling tiling);
    ...
    ADESK_DEPRECATED virtual    Tiling                 tiling        (void) const;

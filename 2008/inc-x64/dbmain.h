...
Acad::ErrorStatus acdbSaveAs2004(AcDbDatabase* pDb, const ACHAR* fileName);

Acad::ErrorStatus acdbSaveAs2000(AcDbDatabase* pDb, const ACHAR* fileName);

Acad::ErrorStatus acdbDxfOutAs2004(AcDbDatabase* pDb, const ACHAR* fileName,
                                         const int precision = 16);
Acad::ErrorStatus acdbDxfOutAs2000(AcDbDatabase* pDb, const ACHAR* fileName,
                                         const int precision = 16);
Acad::ErrorStatus acdbDxfOutAsR12(AcDbDatabase* pDb, const ACHAR* fileName,
                                         const int precision = 16);
Acad::ErrorStatus acdbSaveAsR14(AcDbDatabase* pDb, const ACHAR* fileName);
...
public:
    ...
    Acad::ErrorStatus setXclipFrame(bool disp);
...
public:
    ...
    //
    virtual  Acad::ErrorStatus addSubentPaths(
                                  const AcDbFullSubentPathArray& newPaths);

    virtual  Acad::ErrorStatus deleteSubentPaths(
                                  const AcDbFullSubentPathArray& paths);

    virtual  Acad::ErrorStatus getSubentClassId(

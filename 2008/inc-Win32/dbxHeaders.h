...
#pragma comment (lib ,"acdb17.lib")
#pragma comment (lib ,"acge17.lib")
#pragma comment (lib ,"achapi17.lib")
#pragma comment (lib ,"acISMobj17.lib")
#pragma comment (lib ,"acgiapi.lib")
#pragma comment (lib ,"axdb.lib")
#ifdef _HLR_SUPPORT_
	#pragma comment (lib ,"AsdkHlrApi17.lib")
#endif
#ifdef _DBX_HOST_APPLICATION_
	#pragma comment (lib ,"acurlutl17.lib")
#endif // _DBX_HOST_APPLICATION_
#ifdef _BREP_SUPPORT_
	#pragma comment (lib ,"acgex17.lib")
	#pragma comment (lib ,"acbr17.lib")
#endif // _BREP_SUPPORT_
#ifdef _AMODELER_SUPPORT_
	#pragma comment (lib, "aecmodeler50.lib")
#endif // _AMODELER_SUPPORT_
#pragma comment (lib, "acdbmgd.lib")
#else // AC_FULL_DEBUG
#pragma comment (lib ,"rxapi.lib")
#pragma comment (lib ,"acdb17d.lib")
#pragma comment (lib ,"acge17d.lib")
#pragma comment (lib ,"achapi17d.lib")
#pragma comment (lib ,"acISMobj17d.lib")
#pragma comment (lib ,"acgiapi.lib")
#pragma comment (lib ,"axdb.lib")
#ifdef _HLR_SUPPORT_
	#pragma comment (lib ,"AsdkHlrApi17.lib")
#endif
#ifdef _DBX_HOST_APPLICATION_
	#pragma comment (lib ,"acurlutl17d.lib")
#endif // _DBX_HOST_APPLICATION_
#ifdef _BREP_SUPPORT_
	#pragma comment (lib ,"acgex17d.lib")
	#pragma comment (lib ,"acbr17d.lib")
#endif // _BREP_SUPPORT_
#ifdef _AMODELER_SUPPORT_
	#pragma comment (lib, "aecmodeler50d.lib")
#endif // _AMODELER_SUPPORT_
#pragma comment (lib, "acdbmgd.lib")
#endif // AC_FULL_DEBUG
...
//----- Rx Un-Classified
#include "codepgid.h"	//----- This list contains identifiers for all of the code pages used with AutoCAD

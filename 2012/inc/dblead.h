...
//
//  (C) Copyright 1994-2011 by Autodesk, Inc.  All rights reserved.
//
...
public:
    ...
    ACDB_PORT void            setHasArrowHead   (Adesk::Boolean bEnable);
    ...
    ACDB_PORT void            setSplined        (Adesk::Boolean bSplined);
    //
    ...
    ACDB_PORT Acad::ErrorStatus setAnnotationObjId(const AcDbObjectId& annoId);

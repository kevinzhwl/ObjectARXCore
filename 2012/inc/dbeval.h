//
//  (C) Copyright 2040-2011 by Autodesk, Inc.
//
...
public:
    ...
    Acad::ErrorStatus setValue(AcDb::DxfCode groupcode, const Adesk::Int32 value);
    ...
    ACDB_PORT Acad::ErrorStatus getValue(AcString& value) const;

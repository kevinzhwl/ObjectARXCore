...
protected:
    ...
    AcDb::Visibility  subVisibility() const;
    Acad::ErrorStatus subSetVisibility(AcDb::Visibility newVal,
                                        Adesk::Boolean doSubents = true);
...
protected:
    Acad::ErrorStatus  subPushHighlight  (const AcDbFullSubentPath& subId,
                                          AcGiHighlightStyle        highlightStyle);
    Acad::ErrorStatus  subPopHighlight   (const AcDbFullSubentPath& subId);
    AcGiHighlightStyle subHighlightState (const AcDbFullSubentPath& subId);
};

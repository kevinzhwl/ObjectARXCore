//
//
// (C) Copyright 2006-2009 by Autodesk, Inc.
//
...
public:
    ...
    /// form.  Currently, the value of this string is expected to be in the form
    /// of a WKT which upon successful parsing, produces a valid internal MAP
    /// coordinate reference system definition.  In future releases, this 
    /// restriction may be removed.  The setCoordinateSystem member returns
    /// Acad::eOk only if the WKT criteria is met.  Future release may also
    /// support the specification of the grid coordinate system in an XML form,
    /// or an EPSG ID reference in the form "EPSG:4326".
    /// Default = null string.
    /// </summary>
    ...
    /// (e.g. WKT) the z argument will be specified in the same units as x and y.
    ///

//
//  (C) Copyright 1996-2010 by Autodesk, Inc.
//
...
public:
    ...
    // This overload, without the size arg, will go away in a future
    // release.  Please convert to the other overload.
    ADESK_DEPRECATED static Acad::ErrorStatus     suggestName(

...
public:
    ...
    ///
    double itemSpacing(AcString& expression = AcString(), AcString& evaluatorId = AcString()) const;
    ...
    ///
    double startOffset(AcString& expression = AcString(), AcString& evaluatorId = AcString()) const;
    ...
    ///
    double endOffset(AcString& expression = AcString(), AcString& evaluatorId = AcString()) const;

...
public:
    ...
    ///
    int itemCount(AcString& expression = AcString(), AcString& evaluatorId = AcString()) const;
    ...
    ///
    double angleBetweenItems(AcString& expression = AcString(), AcString& evaluatorId = AcString()) const;
    ...
    ///
    double fillAngle(AcString& expression = AcString(), AcString& evaluatorId = AcString()) const;
    ...
    /// <returns> Returns angle between first and last item. </returns>
    ///
    double startAngle(AcString& expression = AcString(), AcString& evaluatorId = AcString()) const;
    ...
    ///
    double radius(AcString& expression = AcString(), AcString& evaluatorId = AcString()) const;

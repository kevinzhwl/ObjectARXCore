//
//
// (C) Copyright 1992-2011 by Autodesk, Inc.
//
...
class ADESK_NO_VTABLE AcRxClass: public AcRxObject
{
public:
    ...
    ACDB_PORT AcRxMemberCollection* members() const;
    ACDB_PORT const AcRxAttributeCollection& attributes() const;
    ACDB_PORT AcRxAttributeCollection& attributes();
};
...
ACDB_PORT AcRxClass* newAcRxClass(
    const ACHAR* className,
    const ACHAR* parentClassName,
    int         dwgVer,
    int         maintVer,

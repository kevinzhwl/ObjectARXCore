//
//  (C) Copyright 1992-2011 by Autodesk, Inc.  All rights reserved.
//
...
#define ACADV_BLDSTREAM F   /*BuildStream*/
#define ACADV_BLDMAJOR  51   /*BuildMajor*/
...
#define ASM_FILE_RELMAJOR  217
#define ASM_FILE_RELMINOR  0
#define ASM_FILE_RELPOINT  0
#define ASM_FILE_RELPATCH  4503
#define ASM_PROD_RELMAJOR  217
#define ASM_PROD_RELMINOR  0
#define ASM_PROD_RELPOINT  0
#define ASM_PROD_RELPATCH  4503
#endif /* _ID_H */

...
///<summary> 
/// The AcDbTextEditorSelectable is a pure interface to repersent the locations for
...
public:
    ...
    /// </returns>
    ACDB_PORT static double     minLineSpacingFactor();
    ///<summary> 
    /// Minimum allowable line spacing factor.  
    ///</summary>
    /// <returns>
    /// Returns minimum allowable  line spacing factor.
    /// </returns>
    ACDB_PORT static double     maxLineSpacingFactor();

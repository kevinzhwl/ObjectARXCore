...
/// </para> </summary>
///
class ACDB_PORT AcDbAssocDependency : public AcDbObject
{
public: 
    ...
    /// </para> <para>
    /// The object may refuse dependencies being attached to it by using or
    /// deriving from AcDbAssocDependencyPE AcRx protocol extension class and 
    /// attaching it to the object's AcRxClass. In this case attachToObject()
    /// then returns eVetoed error status. The client code should check the
    /// returned error status and do not assume that it is always eOk.
    /// </para> </summary>
    ...
    ///
    virtual void erased(const AcDbObject* dbObj, Adesk::Boolean isErasing = true);
...
/// </summary> 
///
class ACDB_PORT AcDbAssocDependencyNotificationDisabler
{
public: 

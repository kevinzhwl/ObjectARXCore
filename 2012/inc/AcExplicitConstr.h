...
public:
  ...
  /// Input AcConstraintGroupNodeId indicating the constrained line whose direction
  ...
  /// </param>
  /// 
  AcDistanceConstraint(const AcConstraintGroupNodeId consLineId, DirectionType type = kPerpendicularToLine);
  ...
  /// </summary>
  /// <returns> Returns AcConstraintGroupNodeId. </returns>
  ///
  AcConstraintGroupNodeId         constrainedLineId()   const;
};

...
public:
    ...
    virtual const char* getConstant() const = 0;
};
...
public:
    ...
    virtual Acad::ErrorStatus setName(const char*);
    ...
    virtual const char* filterExpression() const;
    virtual Acad::ErrorStatus setFilterExpression(const char* expr);

...
const Acad::ErrorStatus eLoadFailed = eLoadFailed;
const Acad::ErrorStatus eDeviceNotFound = eDeviceNotFound;
const Acad::ErrorStatus eNoCurrentConfig = eNoCurrentConfig;
const Acad::ErrorStatus eNullPtr = eNullPtr;
const Acad::ErrorStatus eNoLayout = eNoLayout;
const Acad::ErrorStatus eIncompatiblePlotSettings = eIncompatiblePlotSettings;
const Acad::ErrorStatus eNonePlotDevice = eNonePlotDevice;
const Acad::ErrorStatus eNoMatchingMedia = eNoMatchingMedia;
const Acad::ErrorStatus eInvalidView = eInvalidView;
const Acad::ErrorStatus eInvalidWindowArea = eInvalidWindowArea;
const Acad::ErrorStatus eInvalidPlotArea = eInvalidPlotArea;
const Acad::ErrorStatus eCustomSizeNotPossible = eCustomSizeNotPossible;

const Acad::ErrorStatus ePageCancelled = ePageCancelled;
const Acad::ErrorStatus ePlotCancelled = ePlotCancelled;
const Acad::ErrorStatus eInvalidEngineState = eInvalidEngineState;
const Acad::ErrorStatus ePlotAlreadyStarted = ePlotAlreadyStarted;
const Acad::ErrorStatus eNoErrorHandler = eNoErrorHandler;
const Acad::ErrorStatus eInvalidPlotInfo = eInvalidPlotInfo;
const Acad::ErrorStatus eNumberOfCopiesNotSupported = eNumberOfCopiesNotSupported;
const Acad::ErrorStatus eLayoutNotCurrent = eLayoutNotCurrent;
const Acad::ErrorStatus eGraphicsNotGenerated = eGraphicsNotGenerated;
const Acad::ErrorStatus eCannotPlotToFile = eCannotPlotToFile;
const Acad::ErrorStatus eMustPlotToFile = eMustPlotToFile;
const Acad::ErrorStatus eBackgroundPlotInProgress = eBackgroundPlotInProgress;
...
const AcDb::DxfCode kDxfUndo = AcDb::kDxfUndo;

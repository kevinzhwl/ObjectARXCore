...
//
// (C) Copyright 1996-1999,2001-2002 by Autodesk, Inc.
//
...
public:
    ...
    virtual const char* originalClassName() const = 0;
    virtual const char* originalDxfName() const = 0;
    virtual const char* applicationDescription() const = 0;

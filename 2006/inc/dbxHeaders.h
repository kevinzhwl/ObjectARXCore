...
#pragma comment (lib ,"axdb16.lib")
#ifdef _HLR_SUPPORT_
	#pragma comment (lib ,"AsdkHlrApi16.lib")
#endif
#ifdef _DBX_HOST_APPLICATION_
	#pragma comment (lib ,"acdbxref16.lib")
	#pragma comment (lib ,"acurlutl16.lib")
#endif // _DBX_HOST_APPLICATION_
#ifdef _BREP_SUPPORT_
	#pragma comment (lib ,"acgex16.lib")
	#pragma comment (lib ,"acbr16.lib")
#endif // _BREP_SUPPORT_
#ifdef _IE_SDK_SUPPORT_
	#pragma comment (lib, "ie80.lib")
#endif // _IE_SDK_SUPPORT_
#ifdef _AMODELER_SUPPORT_
	#pragma comment (lib, "aecmodeler47.lib")

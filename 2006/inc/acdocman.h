...
#define ACDOCMAN_H
//
//  (C) Copyright 1992-2003 by Autodesk, Inc.  All rights reserved.
//
...
public:
    ...
    //
     enum SaveFormat {
        ...
        kNative = k2004_dwg, // Current dwg version is 2004
...
public:
    ...
    struct DocOpenParams {
        ...
        enum {kUnknown = 0,             // not used
              ...
              kViewWorldCoords = 6};
        unsigned char mnInitialViewType;

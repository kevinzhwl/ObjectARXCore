...
public:
    ...
    /// </remarks>
    /// 
    AcDbEvalVariant (const char*  szVal);
    ...
    /// </remarks>
    /// 
    AcDbEvalVariant& operator=(long        lVal);
    ...
    /// </remarks>
    /// 
    AcDbEvalVariant& operator=(const char* szVal);
    ...
    /// <summary>
    /// An enumaration of supported types that can be contained in an
    /// AcDbEvalVariant. The current type of an AcDbEvalVariant instance is
    /// stored in its <c>restype</c> member. 
    /// </summary>
    /// 
    enum Type {
        ...
        /// </summary>
        /// 
        kNone    = AcDb::kDxfInvalid,

        /// <summary>
        /// Variant type short integer.
        /// </summary>
        ///
        kShort   = AcDb::kDxfInt16,

        /// <summary>
        /// Variant type long integer. 
        /// </summary>
        ///
        kLong    = AcDb::kDxfInt32,

        /// <summary>
        /// Variant type floating double precision.
        /// </summary>
        ///
        kDouble  = AcDb::kDxfReal,

        /// <summary>
        /// Variant type string. 
        /// </summary>
        ///
        kString  = AcDb::kDxfText,

        /// <summary>
        /// Variant type entity name (ads_name).
        /// </summary>
        ///
        kOldId   = AcDb::kDxfInt32+1,

        /// <summary>
        /// Variant type 2d point.
        /// </summary>
        ///
        kPoint2d = AcDb::kDxfXCoord,

        /// <summary>
        /// Variant type 3d point.
        /// </summary>
        ///
        kPoint3d = AcDb::kDxfXCoord+1
    };
    ...
    /// </returns>
    virtual Acad::ErrorStatus copyFrom(const AcRxObject* pOther);
...
public:
    ...
    virtual Acad::ErrorStatus getConnectionType  (
                                    const AcString&        name, 
                                    AcDbEvalVariant::Type& type) const;
...
public:
    ...
    /// </param>
    ///
    virtual void        removeAt (const char*                szKey);
...
private:
    ...
    friend AcDbImpEvalContextIterator;
};
...
public:
    ...
    /// </param>
    ///
    AcDbEvalContextPair(const char* szKey, void *pValue);

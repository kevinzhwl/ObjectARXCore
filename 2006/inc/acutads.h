...
void           acad__assert(const char *, const char *, int);

int            acutCvUnit (ads_real value, const char *oldunit,
                             const char *newunit, ads_real *result);
int            acutWcMatch (const char *string, const char *pattern);

int            acutPrintf (const char *format, ...);
int            acutSPrintf (char *buffer, const char *format, ...);

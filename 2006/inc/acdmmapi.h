...
public:
    ...
    /// </returns>
    virtual const char * UniqueLayoutId() = 0; 
...
/// </remarks>
///
void AcGlobalAddDMMReactor(AcDMMReactor * pReactor);
...
/// previously added.
/// </param>
void AcGlobalRemoveDMMReactor(AcDMMReactor * pReactor);

typedef (__cdecl * ACGLOBADDDMMREACTOR)(AcDMMReactor * pReactor);
typedef (__cdecl * ACGLOBREMOVEDMMREACTOR)(AcDMMReactor * pReactor);

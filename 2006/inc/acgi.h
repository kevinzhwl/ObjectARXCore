...
#define _ACGI_H 1
//
// (C) Copyright 1994-2002,2004 by Autodesk, Inc. 
//
...
public:
    ...
    /*NEW*/virtual AcDb::LineWeight  byBlockLineWeight() const { return AcDb::kLnWt000; }
...
public:
    ...
    /*NEW*/virtual void setMaterial(const AcDbObjectId materialId);
    /*NEW*/virtual void setMapper(const AcGiMapper * mapper);
    ...
    /*NEW*/virtual AcDbObjectId  materialId(void) const;
    /*NEW*/virtual const AcGiMapper * mapper    (void) const;
};

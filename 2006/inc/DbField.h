//////////////////////////////////////////////////////////////////////////////
//
// (C) Copyright 2004-2005  by Autodesk, Inc.
//
...
ACDB_PORT Acad::ErrorStatus acdbMakeFieldCode(const ACHAR * pszFieldExpr, 
                                            ACHAR*& pszFieldCode, 
                                            const ACHAR * pszEvalId  = NULL, 
                                            const ACHAR * pszFormat  = NULL, 
                                            const ACHAR * pszHLUrl   = NULL, 
                                            const ACHAR * pszHLDesc  = NULL, 
                                            const ACHAR * pszHLSubLoc = NULL);

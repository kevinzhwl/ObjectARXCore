...
public:
    ...
    virtual void setName(const TCHAR * cName) = 0; 

    // Get/Set the description or friendly name.
    virtual const TCHAR * description() const = 0;  
    virtual void setDescription(const TCHAR * cDescription) = 0;
    
    // Get/Set the sublocation/named view.
    virtual const TCHAR * subLocation() const = 0;  
    virtual void setSubLocation(const TCHAR * cSubLocation) = 0;
    ...
    virtual const TCHAR * getDisplayString() const = 0;  
...
{
    return  AcDbHyperlink::HLinkFlags::kUndefined;
}
...
public:
    ...
    virtual void addHead(const TCHAR * sName, const TCHAR * sDescription, const TCHAR * sSubLocation = NULL) = 0;
    virtual void addTail(const TCHAR * sName, const TCHAR * sDescription, const TCHAR * sSubLocation = NULL) = 0;
    virtual void addAt(const int nIndex, const TCHAR * sName, const TCHAR * sDescription, const TCHAR * sSubLocation = NULL) = 0;
...
#define HAPI_SERVICE  "AcadHyperlinks"

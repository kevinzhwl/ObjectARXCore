...
DllImpExp extern const double gEpsNor;     // TODO-Jiri Kripac: The const is for DLL compatibility only
DllImpExp extern const double gEpsNorSqrd; // TODO-Jiri Kripac: The const is for DLL compatibility only
...
// TODO-Jiri Kripac: Commented out for DLL compatibility reasons (the epsNor is const)
#if 0

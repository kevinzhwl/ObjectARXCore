...
Adesk::Boolean 
AsdkBody::worldDraw(AcGiWorldDraw* worldDraw)
{
    assertReadEnabled();

    AcDbEntity::worldDraw(worldDraw);
...
Acad::ErrorStatus 
AsdkBody::transformBy(const AcGeMatrix3d& xform)
{
    AcDbDwgFiler *filer;
    ...
    {
        filer->writeItem( (long)AsdkBody::desc() );
...
acrxEntryPoint( AcRx::AppMsgCode msg, void *pkt )
{
    ...
    case AcRx::kInitAppMsg:
		...
		//
        acrxLoadModule("aecmodeler47.dbx",0);
    ...
    case AcRx::kUnloadAppMsg:
		...
		acrxUnloadModule("aecmodeler47.dbx");
        break;
    }
    return AcRx::kRetOK;
}

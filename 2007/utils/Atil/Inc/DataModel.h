...
public:
    ...
    /// <summary>
    /// This static method will covert the <c>TileSize</c> enum entry into
...
public:
    ...
    /// based DataModel derivation (RgbModel). 
    /// </remarks>
    ///
    ...
    ///
    /// <remarks>
    /// Each internal ATIL derived datamodel will implement its own operators to 
...
protected:
    ...
    /// <param name="dmt">
    /// A constant enum described in <c>DataModelAttributes</c> that declares
    /// the type of the datamodel to be contructed.
    /// </param>
    ///
    /// <param name="format">
    /// A constant enum described in <c>DataModelAttributes</c> that declares

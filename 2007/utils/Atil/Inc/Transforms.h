...
/// </param>
/// 
/// <param name="dXShear">A const double reference with the rotation angle
...
public:
    ...
    // kInterpolated ;
    // kNearestNeighbor takes the color of the nearest pixel and does not preserve 
    // the image integrity as well.
    enum RotationMethod { 
        /// <summary>

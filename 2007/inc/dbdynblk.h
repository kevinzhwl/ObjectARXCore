...
// block references, discovering dynamic block properties. 
//
...
public:
    ...
    /// </returns>
    AcDbEvalVariant::Type propertyType ()  const;
...
private:
    ...
    friend AcDbImpDynBlockReferenceProperty;
    friend AcDbImpDynBlockReference;
};

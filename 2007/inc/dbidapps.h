...
{ return c4ObjIdIsLessThan(reinterpret_cast<ULONG_PTR>(mId),
                           reinterpret_cast<ULONG_PTR>(id.mId));
}

inline bool
AcDbR13ObjectId::operator > (const AcDbR13ObjectId& id) const
{ return c4ObjIdIsGreaterThan(reinterpret_cast<ULONG_PTR>(mId),
                              reinterpret_cast<ULONG_PTR>(id.mId));
}

inline bool
AcDbR13ObjectId::operator <= (const AcDbR13ObjectId& id) const
{ return c4ObjIdLessThanOrEqual(reinterpret_cast<ULONG_PTR>(mId),
                                reinterpret_cast<ULONG_PTR>(id.mId));
}

inline bool
AcDbR13ObjectId::operator >= (const AcDbR13ObjectId& id) const
{ return c4ObjIdGreaterThanOrEqual(reinterpret_cast<ULONG_PTR>(mId),
                                   reinterpret_cast<ULONG_PTR>(id.mId));
}

inline bool
AcDbR13ObjectId::operator == (const AcDbR13ObjectId& id) const
{ return c4ObjIdIsEqualTo(reinterpret_cast<ULONG_PTR>(mId),
                          reinterpret_cast<ULONG_PTR>(id.mId));
}

inline bool
AcDbR13ObjectId::operator != (const AcDbR13ObjectId& id) const
{ return c4ObjIdNotEqualTo(reinterpret_cast<ULONG_PTR>(mId),
                           reinterpret_cast<ULONG_PTR>(id.mId));
}
...
{ return c4ObjIdIsLessThan(reinterpret_cast<ULONG_PTR>(mId),
                           reinterpret_cast<ULONG_PTR>(pStub)); }

...
// UNICODE: TODO: SPAGO: Standard CRT functions like _wfopen 
// are declared deprecated (since VC8), for now we are just 
// trying to suppress warning C4996. When time allows, we might 
// want to consider using safe string functions like _wfopen_s.
#pragma warning(push)

...
bool
c4ObjIdIsLessThan(ULONG_PTR lhs, ULONG_PTR rhs); 

bool
c4ObjIdIsGreaterThan(ULONG_PTR lhs, ULONG_PTR rhs); 

bool
c4ObjIdLessThanOrEqual(ULONG_PTR lhs, ULONG_PTR rhs); 

bool
c4ObjIdGreaterThanOrEqual(ULONG_PTR lhs, ULONG_PTR rhs); 

bool
c4ObjIdIsEqualTo(ULONG_PTR lhs, ULONG_PTR rhs); 

bool
c4ObjIdNotEqualTo(ULONG_PTR lhs, ULONG_PTR rhs); 

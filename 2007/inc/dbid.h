...
public:
    ...
    AcDbObjectId&  setFromOldId(LONG_PTR oldId);
...
inline
LONG_PTR AcDbObjectId::asOldId() const
{ return reinterpret_cast<LONG_PTR>(mId); }

inline
AcDbObjectId& AcDbObjectId::setFromOldId(LONG_PTR oldId)
{ mId = reinterpret_cast<AcDbStub*>(oldId); return *this; }

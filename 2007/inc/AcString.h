...
class AcString : public AcHeapOperators
{
  public:
    ...
    AcString precat(const ACHAR * psz) const;
...
inline AcString operator + (const ACHAR *psz, const AcString & acs)
{

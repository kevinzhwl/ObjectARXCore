//////////////////////////////////////////////////////////////////////////////
//
//  (C) Copyright 1982-2006 by Autodesk, Inc.
//
...
protected:
    ...
    //}}AFX_MSG
    afx_msg LONG OnDragEnter(WPARAM wParam, LPARAM lParam);
    afx_msg LONG OnDragOver(WPARAM wParam, LPARAM lParam);
    afx_msg LONG OnDragLeave(WPARAM wParam, LPARAM lParam);
    afx_msg LONG OnDrop(WPARAM wParam, LPARAM lParam);
    afx_msg LONG OnDropEx(WPARAM wParam, LPARAM lParam);
    afx_msg LONG OnDragScroll(WPARAM wParam, LPARAM lParam);
    afx_msg LONG OnBeginLabelEdit(WPARAM wParam, LPARAM lParam);
    afx_msg LONG OnEndLabelEdit(WPARAM wParam, LPARAM lParam);
    afx_msg LONG OnGiveFeedback(WPARAM wParam, LPARAM lParam);
    afx_msg LONG OnBeginAcadDrop(WPARAM wParam, LPARAM lParam);
    afx_msg LONG OnEndAcadDrop(WPARAM wParam, LPARAM lParam);
    afx_msg LONG OnRenderData(WPARAM wParam, LPARAM lParam);
    afx_msg LONG OnDragEnterToolbarItem(WPARAM wParam, LPARAM lParam);
    afx_msg LONG OnDragOverToolbarItem(WPARAM wParam, LPARAM lParam);
    afx_msg LONG OnDragLeaveToolbarItem(WPARAM wParam, LPARAM lParam);
    afx_msg LONG OnDropToolbarItem(WPARAM wParam, LPARAM lParam);
    afx_msg LONG OnChildAdded(WPARAM wParam, LPARAM lParam);
    afx_msg LONG OnChildDeleted(WPARAM wParam, LPARAM lParam);
    afx_msg LONG OnChildDetached(WPARAM wParam, LPARAM lParam);
    afx_msg LONG OnCloseShapePalette(WPARAM wParam, LPARAM lParam);
    afx_msg LONG OnGetItemCount(WPARAM wParam,LPARAM lParam); // INTERNAL USE ONLY
    afx_msg LONG  OnGetText(WPARAM wParam,LPARAM  lParam);// INTERNAL USE ONLY
    afx_msg LONG OnGetItemTextLen(WPARAM wParam,LPARAM lParam);// INTERNAL USE ONLY
    afx_msg LONG OnGetItemRect(WPARAM wParam,LPARAM lParam);// INTERNAL USE ONLY
    DECLARE_MESSAGE_MAP()

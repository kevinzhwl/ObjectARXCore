...
public:
    ...
    ACDB_PORT virtual Acad::ErrorStatus getClassID(CLSID* pClsid) const;
    ...
    ACDB_PORT virtual Adesk::Boolean worldDraw(AcGiWorldDraw* wd);
    ACDB_PORT virtual Acad::ErrorStatus getGripPoints(AcDbGripDataPtrArray& grips, 
                                             const double curViewUnitSize, 
                                             const int gripSize, 
                                             const AcGeVector3d& curViewDir, 
                                             const int bitflags) const;
    ACDB_PORT virtual Acad::ErrorStatus moveGripPointsAt(const AcDbVoidPtrArray& gripAppData, 
                                             const AcGeVector3d& offset, 
                                             const int bitflags);
    ACDB_PORT virtual Acad::ErrorStatus subClose();
    ACDB_PORT virtual Acad::ErrorStatus getOsnapPoints(AcDb::OsnapMode osnapMode, 
                                             int gsSelectionMark, 
    ...
    ACDB_PORT virtual Acad::ErrorStatus transformBy(const AcGeMatrix3d& xform);
    ACDB_PORT virtual void list             (void) const;
    ACDB_PORT virtual Acad::ErrorStatus getGeomExtents(AcDbExtents& extents) const;

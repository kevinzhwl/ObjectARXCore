...
This sample demonstrates the use of AsdkHlrApi16.

The AsdkHlrApi16 module is there to help to calculate hidden lines 
...
To use these applications, AsdkHlrApi16.dbx must be in the Autodesk Common 
files folder. First the OS must find it and second AutoCAD must find it for 
the acrxLoadModule("AsdkHlrApi.dbx",0) call to succeed.

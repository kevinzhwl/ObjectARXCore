...
public:
    ...
    //                      is already active. 
    //
    virtual Acad::ErrorStatus activateOsnapMode(const char* modeStr) = 0;
    ...
    // is returned.
    // 
    virtual Acad::ErrorStatus deactivateOsnapMode(const char* modeStr) = 0;
    ...
    //
    virtual Adesk::Boolean modeIsActive(const char* modeStr) = 0;

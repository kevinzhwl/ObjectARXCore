...
{ return c4ObjIdIsLessThan(mId, id.mId); }

inline bool
AcDbR13ObjectId::operator > (const AcDbR13ObjectId& id) const
{ return c4ObjIdIsGreaterThan(mId, id.mId); }

inline bool
AcDbR13ObjectId::operator <= (const AcDbR13ObjectId& id) const
{ return c4ObjIdLessThanOrEqual(mId, id.mId); }

inline bool
AcDbR13ObjectId::operator >= (const AcDbR13ObjectId& id) const
{ return c4ObjIdGreaterThanOrEqual(mId, id.mId); }

inline bool
AcDbR13ObjectId::operator == (const AcDbR13ObjectId& id) const
{ return c4ObjIdIsEqualTo(mId, id.mId); }

inline bool
AcDbR13ObjectId::operator != (const AcDbR13ObjectId& id) const
{ return c4ObjIdNotEqualTo(mId, id.mId); }
...
{ return c4ObjIdIsLessThan(mId, (unsigned long)(pStub)); }

inline bool
AcDbR13ObjectId::operator > (const AcDbStub* pStub) const
{ return c4ObjIdIsGreaterThan(mId, (unsigned long)(pStub)); }

inline bool
AcDbR13ObjectId::operator <= (const AcDbStub* pStub) const
{ return c4ObjIdLessThanOrEqual(mId, (unsigned long)(pStub)); }

inline bool
AcDbR13ObjectId::operator >= (const AcDbStub* pStub) const
{ return c4ObjIdGreaterThanOrEqual(mId, (unsigned long)(pStub)); }

inline bool
AcDbR13ObjectId::operator == (const AcDbStub* pStub) const
{ return c4ObjIdIsEqualTo(mId, (unsigned long)(pStub)); }

inline bool
AcDbR13ObjectId::operator != (const AcDbStub* pStub) const
{ return c4ObjIdNotEqualTo(mId, (unsigned long)(pStub)); }

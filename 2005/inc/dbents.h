...
#define AD_DBENTS_H
//
//  Copyright 1993-1999,2001-2003 by Autodesk, Inc.
//
...
public:
    ...
    const char*         textStringConst() const;
...
public:
    ...
    char*               prompt() const;
    const char*         promptConst() const;
    Acad::ErrorStatus   setPrompt(const char*);
     
    char*               tag() const;
    const char*         tagConst() const;
...
public:
    ...
    enum StandardScaleType {
        ...
        k1ft_1ft                      // 1'= 1'
            ...
            Acad::ErrorStatus plotStyleSheet(char *&) const;
            Acad::ErrorStatus plotStyleSheet(const char *&) const;
            Acad::ErrorStatus effectivePlotStyleSheet(const char *&);
            Acad::ErrorStatus setPlotStyleSheet(const char *);

...
public:
    ...
    ACPL_PORT AcPlPlotConfigInfo(const char* pDevName,
...
public:
    ...
    virtual bool getStyleList(AcArray<char*> &list, 
                              long styType = StyTypes::kAllTypes);
    ...
    virtual const char* getStdConfigName(StdConfigs stdConfig);
...
ACPL_PORT AcPlPlotConfigManager* __stdcall acplPlotConfigManagerPtr();

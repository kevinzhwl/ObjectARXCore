...
public:
    ...
    virtual AcDbDataCell& operator = (const char* pChar);
...
public:
    ...
    virtual Acad::ErrorStatus setColumnName(const char* pName);
...
public:
    ...
    virtual Acad::ErrorStatus setTableName(const char* pName);
    ...
    virtual Acad::ErrorStatus getColumnIndexAtName(
        const char* pName, Adesk::UInt32& index) const;

    virtual Acad::ErrorStatus appendColumn(
        AcDbDataCell::CellType type, const char* pColName = NULL);

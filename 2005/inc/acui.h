...
void ACUI_PORT InitAcUiDLL();

/////////////////////////////////////////////////////////////////////////////

HINSTANCE ACUI_PORT AcUiAppResourceInstance ();
LPCTSTR ACUI_PORT AcUiContextHelpFileName();
BOOL ACUI_PORT AcUiEnableToolTips ();
BOOL ACUI_PORT AcUiFindContextHelpFullPath (
    LPCTSTR fileName, CString& fullPath
);
BOOL ACUI_PORT AcUiIsInputPending ();
CWnd ACUI_PORT * AcUiMainWindow ();
void ACUI_PORT AcUiRootKey (CString& rootKey);

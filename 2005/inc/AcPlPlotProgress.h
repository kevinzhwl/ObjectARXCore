...
public:
    ...
    virtual bool setStatusMsgString(const char *pMsg) = 0;
    virtual bool getStatusMsgString(char*& pMsg) const = 0;
...
public:
    ...
    virtual bool setPlotMsgString(PlotMSGIndex index, const char *pMsg) = 0;
    virtual bool getPlotMsgString(PlotMSGIndex index, char*& pMsg) const = 0;

...
//
// (C) Copyright 2002-2002 by Autodesk, Inc. 
//
...
class AcFileDependencyInfo {
    public:
        const char *mpFullFileName;
        const char *mpFileName;
        const char *mpFoundPath;
        const char *mpFingerprintGuid;
        const char *mpVersionGuid;
        const char *mpFeature;
        bool        mIsModified;
...
///////////////////////////////////////////////
        ...
        virtual long createEntry(const char *feature,
        ...
        virtual Acad::ErrorStatus getEntry(const char *feature,
                                           const char *fullFileName,
        ...
        virtual Acad::ErrorStatus updateEntry(const char *feature,
                                              const char *fullFileName) = 0;
        ...
        virtual Acad::ErrorStatus eraseEntry(const char *feature,
                                             const char *fullFileName,
...
///////////////////////////////////////////////
        ...
        virtual void iteratorInitialize(const char *feature = NULL, 

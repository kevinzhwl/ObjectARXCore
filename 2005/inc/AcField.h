...
public:
    ...
    ACDB_PORT virtual const char* evaluatorId(void) const;
    ACDB_PORT virtual const char* evaluatorId(AcDbField* pField);
...
public:
    ...
    ACDB_PORT virtual AcFdFieldEvaluator* getEvaluator(LPCTSTR pszEvalId);
    ACDB_PORT virtual AcFdFieldEvaluator * findEvaluator(AcDbField* pField, 
                                             const char*& pszEvalId);
...
public:
    ...
    ACDB_PORT AcFdFieldEvaluator * getEvaluator (LPCTSTR pszEvalId);
...
public:
    ...
    ACDB_PORT AcFdFieldValue(LPCTSTR pszValue);
    ...
    ACDB_PORT       operator LPCTSTR        (void) const;
    ...
    ACDB_PORT AcFdFieldValue& operator=     (LPCTSTR pszValue);
    ...
    ACDB_PORT bool  get                     (const char*& pszValue) const;
    ACDB_PORT bool  get                     (char*& pszValue) const;
    ...
    ACDB_PORT bool  set                     (LPCTSTR pszValue);
    ...
    ACDB_PORT bool  set                     (const void* pBuf, 
                                             DWORD dwBufSize);
    ACDB_PORT bool  format                  (LPCTSTR pszFormat, 
                                             char*& pszValue) const;
